...
;* Date/Time created: Thu Feb 29 14:44:37 2024                 *
;***************************************************************
...
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{42701DE2-A246-4A4B-96A9-F86F376A9D32} 
	.sect	".text"
	.clink
	.global	_AdcSetMode
...
;----------------------------------------------------------------------
        MOV       *-SP[3],AR4           ; [CPU_ALU] |19| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |19| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,#459692          ; [CPU_ARAU] |26| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |26| 
        MOVL      XAR4,#65535           ; [CPU_ARAU] |26| 
        CMPL      ACC,XAR4              ; [CPU_ALU] |26| 
        B         $C$L1,EQ              ; [CPU_ALU] |26| 
        ; branchcc occurs ; [] |26| 
...
;----------------------------------------------------------------------
        ...
        MOVZ      AR6,AL                ; [CPU_ALU] |31| 
        MOV       ACC,*-SP[2] << #1     ; [CPU_ALU] |31| 
        ADD       AL,AR6                ; [CPU_ALU] |31| 
        ADD       AL,*-SP[3]            ; [CPU_ALU] |31| 
        MOV       *-SP[4],AL            ; [CPU_ALU] |31| 
...
;  34 | else {                                                                 
;  35 | //offset trim function is not populated, so set offset trim to 0       
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
        ...
        AND       AH,@$BLOCKED(_AdcaRegs)+1,#0xffbf ; [CPU_ALU] |43| 
        ANDB      AL,#0x01              ; [CPU_ALU] |43| 
        LSL       AL,6                  ; [CPU_ALU] |43| 
        OR        AL,AH                 ; [CPU_ALU] |43| 
        MOV       @$BLOCKED(_AdcaRegs)+1,AL ; [CPU_ALU] |43| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |44| 
        AND       AH,@$BLOCKED(_AdcaRegs)+1,#0xff7f ; [CPU_FPU] |44| 
        LSL       AL,7                  ; [CPU_ALU] |44| 
        OR        AL,AH                 ; [CPU_ALU] |44| 
        MOV       @$BLOCKED(_AdcaRegs)+1,AL ; [CPU_ALU] |44| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |45| 
        MOV       @$BLOCKED(_AdcaRegs)+59,AL ; [CPU_ALU] |45| 
...
;----------------------------------------------------------------------
        ...
        MOV       AL,*-SP[2]            ; [CPU_ALU] |56| 
        AND       AH,@$BLOCKED(_AdcbRegs)+1,#0xffbf ; [CPU_ALU] |56| 
        ANDB      AL,#0x01              ; [CPU_ALU] |56| 
        LSL       AL,6                  ; [CPU_ALU] |56| 
        OR        AL,AH                 ; [CPU_ALU] |56| 
        MOV       @$BLOCKED(_AdcbRegs)+1,AL ; [CPU_ALU] |56| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |57| 
        AND       AH,@$BLOCKED(_AdcbRegs)+1,#0xff7f ; [CPU_FPU] |57| 
        LSL       AL,7                  ; [CPU_ALU] |57| 
        OR        AL,AH                 ; [CPU_ALU] |57| 
        MOV       @$BLOCKED(_AdcbRegs)+1,AL ; [CPU_ALU] |57| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |58| 
        MOV       @$BLOCKED(_AdcbRegs)+59,AL ; [CPU_ALU] |58| 
...
;----------------------------------------------------------------------
        ...
        MOV       AL,*-SP[2]            ; [CPU_ALU] |69| 
        AND       AH,@$BLOCKED(_AdccRegs)+1,#0xffbf ; [CPU_ALU] |69| 
        ANDB      AL,#0x01              ; [CPU_ALU] |69| 
        LSL       AL,6                  ; [CPU_ALU] |69| 
        OR        AL,AH                 ; [CPU_ALU] |69| 
        MOV       @$BLOCKED(_AdccRegs)+1,AL ; [CPU_ALU] |69| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |70| 
        AND       AH,@$BLOCKED(_AdccRegs)+1,#0xff7f ; [CPU_FPU] |70| 
        LSL       AL,7                  ; [CPU_ALU] |70| 
        OR        AL,AH                 ; [CPU_ALU] |70| 
        MOV       @$BLOCKED(_AdccRegs)+1,AL ; [CPU_ALU] |70| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |71| 
        MOV       @$BLOCKED(_AdccRegs)+59,AL ; [CPU_ALU] |71| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |72| 
        B         $C$L7,NEQ             ; [CPU_ALU] |72| 
        ; branchcc occurs ; [] |72| 
...
;----------------------------------------------------------------------
        ...
        MOV       AL,*-SP[2]            ; [CPU_ALU] |82| 
        AND       AH,@$BLOCKED(_AdcdRegs)+1,#0xffbf ; [CPU_ALU] |82| 
        ANDB      AL,#0x01              ; [CPU_ALU] |82| 
        LSL       AL,6                  ; [CPU_ALU] |82| 
        OR        AL,AH                 ; [CPU_ALU] |82| 
        MOV       @$BLOCKED(_AdcdRegs)+1,AL ; [CPU_ALU] |82| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |83| 
        ANDB      AL,#0x01              ; [CPU_ALU] |83| 
        AND       AH,@$BLOCKED(_AdcdRegs)+1,#0xff7f ; [CPU_FPU] |83| 
        LSL       AL,7                  ; [CPU_ALU] |83| 
        OR        AL,AH                 ; [CPU_ALU] |83| 
        MOV       @$BLOCKED(_AdcdRegs)+1,AL ; [CPU_ALU] |83| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |84| 
        MOV       @$BLOCKED(_AdcdRegs)+59,AL ; [CPU_ALU] |84| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |85| 
        B         $C$L7,NEQ             ; [CPU_ALU] |85| 
        ; branchcc occurs ; [] |85| 
...
$C$L6:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_Adc.c",line 41,column 2,is_stmt,isa 0
        MOV       AL,*-SP[1]            ; [CPU_ALU] |41| 
        B         $C$L2,EQ              ; [CPU_ALU] |41| 
        ; branchcc occurs ; [] |41| 
        CMPB      AL,#1                 ; [CPU_ALU] |41| 
        B         $C$L3,EQ              ; [CPU_ALU] |41| 
        ; branchcc occurs ; [] |41| 
        CMPB      AL,#2                 ; [CPU_ALU] |41| 
        B         $C$L4,EQ              ; [CPU_ALU] |41| 
        ; branchcc occurs ; [] |41| 
        CMPB      AL,#3                 ; [CPU_ALU] |41| 
        B         $C$L5,EQ              ; [CPU_ALU] |41| 
        ; branchcc occurs ; [] |41| 
        B         $C$L7,UNC             ; [CPU_ALU] |41| 
        ; branch occurs ; [] |41| 
$C$L7:    
        SUBB      SP,#6                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
...
;----------------------------------------------------------------------
        ...
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |115| 
        MOVL      XAR4,#65535           ; [CPU_ARAU] |115| 
        CMPL      ACC,XAR4              ; [CPU_ALU] |115| 
        B         $C$L13,EQ             ; [CPU_ALU] |115| 
        ; branchcc occurs ; [] |115| 
...
;----------------------------------------------------------------------
        ...
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |124| 
        MOVL      XAR4,#65535           ; [CPU_ARAU] |124| 
        CMPL      ACC,XAR4              ; [CPU_ALU] |124| 
        B         $C$L13,EQ             ; [CPU_ALU] |124| 
        ; branchcc occurs ; [] |124| 
...
;----------------------------------------------------------------------
        ...
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |133| 
        MOVL      XAR4,#65535           ; [CPU_ARAU] |133| 
        CMPL      ACC,XAR4              ; [CPU_ALU] |133| 
        B         $C$L13,EQ             ; [CPU_ALU] |133| 
        ; branchcc occurs ; [] |133| 
...
$C$L12:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_Adc.c",line 104,column 2,is_stmt,isa 0
        ...
        B         $C$L8,EQ              ; [CPU_ALU] |104| 
        ; branchcc occurs ; [] |104| 
        CMPB      AL,#1                 ; [CPU_ALU] |104| 
        B         $C$L9,EQ              ; [CPU_ALU] |104| 
        ; branchcc occurs ; [] |104| 
        CMPB      AL,#2                 ; [CPU_ALU] |104| 
        B         $C$L10,EQ             ; [CPU_ALU] |104| 
        ; branchcc occurs ; [] |104| 
        CMPB      AL,#3                 ; [CPU_ALU] |104| 
        B         $C$L11,EQ             ; [CPU_ALU] |104| 
        ; branchcc occurs ; [] |104| 
        B         $C$L13,UNC            ; [CPU_ALU] |104| 
        ; branch occurs ; [] |104| 
$C$L13:    
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
...
$C$DW$630	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$630, DW_AT_name("R2H")
	.dwattr $C$DW$630, DW_AT_location[DW_OP_regx 0x33]

$C$DW$631	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$631, DW_AT_name("R3H")
	.dwattr $C$DW$631, DW_AT_location[DW_OP_regx 0x37]

$C$DW$632	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$632, DW_AT_name("R4H")
	.dwattr $C$DW$632, DW_AT_location[DW_OP_regx 0x3b]

$C$DW$633	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$633, DW_AT_name("R5H")
	.dwattr $C$DW$633, DW_AT_location[DW_OP_regx 0x3f]

$C$DW$634	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$634, DW_AT_name("R6H")
	.dwattr $C$DW$634, DW_AT_location[DW_OP_regx 0x43]

$C$DW$635	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$635, DW_AT_name("R7H")
	.dwattr $C$DW$635, DW_AT_location[DW_OP_regx 0x47]

$C$DW$636	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$636, DW_AT_name("RB")
	.dwattr $C$DW$636, DW_AT_location[DW_OP_regx 0x4a]

$C$DW$637	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$637, DW_AT_name("STF")
	.dwattr $C$DW$637, DW_AT_location[DW_OP_regx 0x28]

$C$DW$638	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$638, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$638, DW_AT_location[DW_OP_reg27]

$C$DW$639	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$639, DW_AT_name("STF_HWDIV")
	.dwattr $C$DW$639, DW_AT_location[DW_OP_regx 0x4f]
