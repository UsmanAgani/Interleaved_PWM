...
$C$DW$6	.dwtag  DW_TAG_variable
	...
	.sblock	".ebss"
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{30E89E16-8CFA-48A1-A29C-7F280A09AF4D} 
	.sect	".text"
	.clink
...
;----------------------------------------------------------------------
        MOVL      XAR4,#_CpuTimer0Regs  ; [CPU_ARAU] |27| 
        MOVW      DP,#_CpuTimer0        ; [CPU_ARAU] 
        MOVL      @$BLOCKED(_CpuTimer0),XAR4 ; [CPU_ALU] |27| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |30| 
        MOVW      DP,#_CpuTimer0Regs+2  ; [CPU_ARAU] 
        SUBB      ACC,#1                ; [CPU_ALU] |30| 
        MOVL      @$BLOCKED(_CpuTimer0Regs)+2,ACC ; [CPU_ALU] |30| 
...
;----------------------------------------------------------------------
        MOV       @$BLOCKED(_CpuTimer0Regs)+6,#0 ; [CPU_ALU] |33| 
...
;----------------------------------------------------------------------
        MOV       @$BLOCKED(_CpuTimer0Regs)+7,#0 ; [CPU_ALU] |34| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuTimer0Regs)+4,#0x0010 ; [CPU_ALU] |37| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuTimer0Regs)+4,#0x0020 ; [CPU_ALU] |40| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_CpuTimer0)+2,ACC ; [CPU_ALU] |43| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,#_CpuTimer1Regs  ; [CPU_ARAU] |46| 
        MOVL      @$BLOCKED(_CpuTimer1),XAR4 ; [CPU_ALU] |46| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,#_CpuTimer2Regs  ; [CPU_ARAU] |47| 
        MOVL      @$BLOCKED(_CpuTimer2),XAR4 ; [CPU_ALU] |47| 
...
;----------------------------------------------------------------------
        ...
        SUBB      ACC,#1                ; [CPU_ALU] |50| 
        MOVL      @$BLOCKED(_CpuTimer1Regs)+2,ACC ; [CPU_ALU] |50| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_CpuTimer2Regs)+2,ACC ; [CPU_ALU] |51| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_CpuTimer1Regs)+4,#0x0010 ; [CPU_ALU] |60| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_CpuTimer2Regs)+4,#0x0010 ; [CPU_ALU] |61| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer1Regs+4  ; [CPU_ARAU] 
        OR        @$BLOCKED(_CpuTimer1Regs)+4,#0x0020 ; [CPU_ALU] |64| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer2Regs+4  ; [CPU_ARAU] 
        OR        @$BLOCKED(_CpuTimer2Regs)+4,#0x0020 ; [CPU_ALU] |65| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_CpuTimer1)+2,ACC ; [CPU_ALU] |68| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuTimer2)+2,ACC ; [CPU_ALU] |69| 
...
;----------------------------------------------------------------------
        MOV32     *-SP[6],R1H           ; [CPU_FPU] |81| 
        MOV32     *-SP[4],R0H           ; [CPU_FPU] |81| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |85| 
        MOVL      *+XAR4[4],ACC         ; [CPU_ALU] |85| 
...
;----------------------------------------------------------------------
        ...
        MOVL      ACC,*-SP[6]           ; [CPU_ALU] |86| 
        MOVL      *+XAR4[6],ACC         ; [CPU_ALU] |86| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |88| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |88| 
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |88| 
        SUBB      ACC,#1                ; [CPU_ALU] |88| 
        MOVL      *+XAR4[2],ACC         ; [CPU_ALU] |88| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[2]          ; [CPU_ALU] |91| 
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |91| 
        MOV       *+XAR4[6],#0          ; [CPU_ALU] |91| 
...
;----------------------------------------------------------------------
        ...
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |92| 
        MOV       *+XAR4[7],#0          ; [CPU_ALU] |92| 
...
;----------------------------------------------------------------------
        ...
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |98| 
        AND       *+XAR4[4],#0xfbff     ; [CPU_ALU] |98| 
...
;----------------------------------------------------------------------
        ...
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |99| 
        AND       *+XAR4[4],#0xf7ff     ; [CPU_ALU] |99| 
...
;----------------------------------------------------------------------
        ...
        MOVL      XAR4,*+XAR4[0]        ; [CPU_ALU] |100| 
        OR        *+XAR4[4],#0x4000     ; [CPU_ALU] |100| 
