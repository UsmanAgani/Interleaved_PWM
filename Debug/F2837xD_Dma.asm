...
;* Date/Time created: Thu Feb 29 14:44:38 2024                 *
;***************************************************************
...
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{37F1AA84-B8F1-4DA5-9383-A70846741E5B} 
	.sect	".text"
	.clink
...
;----------------------------------------------------------------------
        ...
        MOV       AH,@$BLOCKED(_DmaClaSrcSelRegs)+22 ; [CPU_ALU] |94| 
        MOVB      AH,AL.LSB             ; [CPU_ALU] |94| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+22,AH ; [CPU_ALU] |94| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+32,#0xffe0 ; [CPU_ALU] |95| 
        ORB       AL,#0x01              ; [CPU_ALU] |95| 
...
;----------------------------------------------------------------------
        ...
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xfeff ; [CPU_FPU] |96| 
        LSL       AL,8                  ; [CPU_ALU] |96| 
        OR        AL,AH                 ; [CPU_ALU] |96| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |97| 
        ANDB      AL,#0x01              ; [CPU_ALU] |97| 
        LSL       AL,10                 ; [CPU_ALU] |97| 
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xfbff ; [CPU_FPU] |97| 
        OR        AL,AH                 ; [CPU_ALU] |97| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |98| 
        ANDB      AL,#0x01              ; [CPU_ALU] |98| 
        LSL       AL,11                 ; [CPU_ALU] |98| 
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xf7ff ; [CPU_FPU] |98| 
        OR        AL,AH                 ; [CPU_ALU] |98| 
        MOV       @$BLOCKED(_DmaRegs)+32,AL ; [CPU_ALU] |98| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |99| 
        ANDB      AL,#0x01              ; [CPU_ALU] |99| 
        LSL       AL,7                  ; [CPU_ALU] |99| 
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xff7f ; [CPU_FPU] |99| 
        OR        AL,AH                 ; [CPU_ALU] |99| 
        MOV       @$BLOCKED(_DmaRegs)+32,AL ; [CPU_ALU] |99| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |100| 
        ANDB      AL,#0x01              ; [CPU_ALU] |100| 
        LSL       AL,14                 ; [CPU_ALU] |100| 
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xbfff ; [CPU_FPU] |100| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |101| 
        ANDB      AL,#0x01              ; [CPU_ALU] |101| 
        LSL       AL,9                  ; [CPU_ALU] |101| 
        AND       AH,@$BLOCKED(_DmaRegs)+32,#0xfdff ; [CPU_FPU] |101| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+32,#0x7fff ; [CPU_ALU] |102| 
        MOVZ      AR6,AL                ; [CPU_ALU] |102| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |102| 
        OR        AL,AR6                ; [CPU_ALU] |102| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+33,#0x0010 ; [CPU_ALU] |105| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+33,#0x0080 ; [CPU_ALU] |106| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0001 ; [CPU_ALU] |109| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+33,#0x0001 ; [CPU_ALU] |118| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+80,ACC ; [CPU_ALU] |127| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+82,ACC ; [CPU_ALU] |128| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |131| 
        MOVL      @$BLOCKED(_DmaRegs)+88,ACC ; [CPU_ALU] |131| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+90,ACC ; [CPU_ALU] |132| 
...
$C$DW$68	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$68, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[2],AH            ; [CPU_ALU] |139| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |139| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+66,AL ; [CPU_ALU] |143| 
...
;     |  addr between each word x-ferred                                       
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |144| 
        MOV       @$BLOCKED(_DmaRegs)+68,AL ; [CPU_ALU] |144| 
...
;     | ddr between each word x-ferred                                         
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |145| 
        MOV       @$BLOCKED(_DmaRegs)+69,AL ; [CPU_ALU] |145| 
...
$C$DW$76	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$76, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |152| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |152| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |152| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+70,AL ; [CPU_ALU] |156| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+72,AL ; [CPU_ALU] |157| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |158| 
        MOV       @$BLOCKED(_DmaRegs)+73,AL ; [CPU_ALU] |158| 
...
$C$DW$86	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$86, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |164| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |164| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |164| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |164| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+74,AL ; [CPU_ALU] |168| 
...
;     | wrap                                                                   
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |169| 
        MOV       @$BLOCKED(_DmaRegs)+76,AL ; [CPU_ALU] |169| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+77,AL ; [CPU_ALU] |171| 
...
;     | tion wrap                                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |172| 
        MOV       @$BLOCKED(_DmaRegs)+79,AL ; [CPU_ALU] |172| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaClaSrcSelRegs+22 ; [CPU_ARAU] 
        MOV       AL,@$BLOCKED(_DmaClaSrcSelRegs)+22 ; [CPU_ALU] |183| 
        MOV       AH,*-SP[1]            ; [CPU_ALU] |183| 
        MOVB      AL.MSB,AH             ; [CPU_ALU] |183| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+22,AL ; [CPU_ALU] |183| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+64,#0xffe0 ; [CPU_ALU] |184| 
        ORB       AL,#0x02              ; [CPU_ALU] |184| 
        MOV       @$BLOCKED(_DmaRegs)+64,AL ; [CPU_ALU] |184| 
...
;     |  enable                                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |185| 
        ANDB      AL,#0x01              ; [CPU_ALU] |185| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xfeff ; [CPU_FPU] |185| 
        LSL       AL,8                  ; [CPU_ALU] |185| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |186| 
        ANDB      AL,#0x01              ; [CPU_ALU] |186| 
        LSL       AL,10                 ; [CPU_ALU] |186| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xfbff ; [CPU_FPU] |186| 
...
;----------------------------------------------------------------------
        ...
        LSL       AL,11                 ; [CPU_ALU] |187| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xf7ff ; [CPU_FPU] |187| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |188| 
        ANDB      AL,#0x01              ; [CPU_ALU] |188| 
        LSL       AL,7                  ; [CPU_ALU] |188| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xff7f ; [CPU_FPU] |188| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |189| 
        ANDB      AL,#0x01              ; [CPU_ALU] |189| 
        LSL       AL,14                 ; [CPU_ALU] |189| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xbfff ; [CPU_FPU] |189| 
        OR        AL,AH                 ; [CPU_ALU] |189| 
        MOV       @$BLOCKED(_DmaRegs)+64,AL ; [CPU_ALU] |189| 
...
;     | o CPU at beginning/end of transfer                                     
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |190| 
        ANDB      AL,#0x01              ; [CPU_ALU] |190| 
        LSL       AL,9                  ; [CPU_ALU] |190| 
        AND       AH,@$BLOCKED(_DmaRegs)+64,#0xfdff ; [CPU_FPU] |190| 
        OR        AL,AH                 ; [CPU_ALU] |190| 
        MOV       @$BLOCKED(_DmaRegs)+64,AL ; [CPU_ALU] |190| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+64,#0x7fff ; [CPU_ALU] |191| 
        MOVZ      AR6,AL                ; [CPU_ALU] |191| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |191| 
        OR        AL,AR6                ; [CPU_ALU] |191| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+65,#0x0010 ; [CPU_ALU] |194| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+65,#0x0080 ; [CPU_ALU] |195| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+14   ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0002 ; [CPU_ALU] |198| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+65,#0x0001 ; [CPU_ALU] |209| 
...
$C$DW$110	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$110, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOVL      *-SP[4],XAR5          ; [CPU_ALU] |216| 
        MOVL      *-SP[2],XAR4          ; [CPU_ALU] |216| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+112,ACC ; [CPU_ALU] |220| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+114,ACC ; [CPU_ALU] |221| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+120,ACC ; [CPU_ALU] |224| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+122,ACC ; [CPU_ALU] |225| 
...
$C$DW$118	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$118, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |232| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |232| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |232| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+98,AL ; [CPU_ALU] |236| 
...
;     |  addr between each word x-ferred                                       
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |237| 
        MOV       @$BLOCKED(_DmaRegs)+100,AL ; [CPU_ALU] |237| 
...
;     | ddr between each word x-ferred                                         
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |238| 
        MOV       @$BLOCKED(_DmaRegs)+101,AL ; [CPU_ALU] |238| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+102,AL ; [CPU_ALU] |249| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |250| 
        MOV       @$BLOCKED(_DmaRegs)+104,AL ; [CPU_ALU] |250| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |251| 
        MOV       @$BLOCKED(_DmaRegs)+105,AL ; [CPU_ALU] |251| 
...
$C$DW$136	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$136, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |257| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |257| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |257| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |257| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+106,AL ; [CPU_ALU] |261| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+108,AL ; [CPU_ALU] |262| 
...
;     |  address after N bursts                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |264| 
        MOV       @$BLOCKED(_DmaRegs)+109,AL ; [CPU_ALU] |264| 
...
;     | tion wrap                                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |265| 
        MOV       @$BLOCKED(_DmaRegs)+111,AL ; [CPU_ALU] |265| 
...
$C$DW$152	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$152, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |272| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |272| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |272| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |272| 
...
;----------------------------------------------------------------------
        ...
        MOV       AH,@$BLOCKED(_DmaClaSrcSelRegs)+23 ; [CPU_ALU] |276| 
        MOVB      AH,AL.LSB             ; [CPU_ALU] |276| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+23,AH ; [CPU_ALU] |276| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+96,#0xffe0 ; [CPU_ALU] |277| 
        ORB       AL,#0x03              ; [CPU_ALU] |277| 
        MOV       @$BLOCKED(_DmaRegs)+96,AL ; [CPU_ALU] |277| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |278| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xfeff ; [CPU_FPU] |278| 
        LSL       AL,8                  ; [CPU_ALU] |278| 
        OR        AL,AH                 ; [CPU_ALU] |278| 
        MOV       @$BLOCKED(_DmaRegs)+96,AL ; [CPU_ALU] |278| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |279| 
        ANDB      AL,#0x01              ; [CPU_ALU] |279| 
        LSL       AL,10                 ; [CPU_ALU] |279| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xfbff ; [CPU_FPU] |279| 
        OR        AL,AH                 ; [CPU_ALU] |279| 
        MOV       @$BLOCKED(_DmaRegs)+96,AL ; [CPU_ALU] |279| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |280| 
        ANDB      AL,#0x01              ; [CPU_ALU] |280| 
        LSL       AL,11                 ; [CPU_ALU] |280| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xf7ff ; [CPU_FPU] |280| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |281| 
        ANDB      AL,#0x01              ; [CPU_ALU] |281| 
        LSL       AL,7                  ; [CPU_ALU] |281| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xff7f ; [CPU_FPU] |281| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |282| 
        ANDB      AL,#0x01              ; [CPU_ALU] |282| 
        LSL       AL,14                 ; [CPU_ALU] |282| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xbfff ; [CPU_FPU] |282| 
...
;     | o CPU at beginning/end of transfer                                     
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |283| 
        ANDB      AL,#0x01              ; [CPU_ALU] |283| 
        LSL       AL,9                  ; [CPU_ALU] |283| 
        AND       AH,@$BLOCKED(_DmaRegs)+96,#0xfdff ; [CPU_FPU] |283| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+96,#0x7fff ; [CPU_ALU] |284| 
        MOVZ      AR6,AL                ; [CPU_ALU] |284| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |284| 
        OR        AL,AR6                ; [CPU_ALU] |284| 
        MOV       @$BLOCKED(_DmaRegs)+96,AL ; [CPU_ALU] |284| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+97,#0x0010 ; [CPU_ALU] |287| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+97,#0x0080 ; [CPU_ALU] |288| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+14   ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0004 ; [CPU_ALU] |291| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+97,#0x0001 ; [CPU_ALU] |300| 
...
;----------------------------------------------------------------------
        ...
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |310| 
        MOVL      @$BLOCKED(_DmaRegs)+144,ACC ; [CPU_ALU] |310| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+146,ACC ; [CPU_ALU] |311| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |314| 
        MOVL      @$BLOCKED(_DmaRegs)+152,ACC ; [CPU_ALU] |314| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+154,ACC ; [CPU_ALU] |315| 
...
$C$DW$168	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$168, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[2],AH            ; [CPU_ALU] |322| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |322| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+130,AL ; [CPU_ALU] |326| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+132,AL ; [CPU_ALU] |327| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+133,AL ; [CPU_ALU] |328| 
...
$C$DW$176	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$176, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |335| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |335| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |335| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+134,AL ; [CPU_ALU] |339| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |340| 
        MOV       @$BLOCKED(_DmaRegs)+136,AL ; [CPU_ALU] |340| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |341| 
        MOV       @$BLOCKED(_DmaRegs)+137,AL ; [CPU_ALU] |341| 
...
$C$DW$186	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$186, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |347| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |347| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |347| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+138,AL ; [CPU_ALU] |351| 
...
;     | wrap                                                                   
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |352| 
        MOV       @$BLOCKED(_DmaRegs)+140,AL ; [CPU_ALU] |352| 
...
;     |  address after N bursts                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |354| 
        MOV       @$BLOCKED(_DmaRegs)+141,AL ; [CPU_ALU] |354| 
...
;     | tion wrap                                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |355| 
        MOV       @$BLOCKED(_DmaRegs)+143,AL ; [CPU_ALU] |355| 
...
$C$DW$202	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$202, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |362| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |362| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |362| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |362| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaClaSrcSelRegs+23 ; [CPU_ARAU] 
        MOV       AL,@$BLOCKED(_DmaClaSrcSelRegs)+23 ; [CPU_ALU] |366| 
        MOV       AH,*-SP[1]            ; [CPU_ALU] |366| 
        MOVB      AL.MSB,AH             ; [CPU_ALU] |366| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+23,AL ; [CPU_ALU] |366| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+128,#0xffe0 ; [CPU_ALU] |367| 
        ORB       AL,#0x04              ; [CPU_ALU] |367| 
        MOV       @$BLOCKED(_DmaRegs)+128,AL ; [CPU_ALU] |367| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |368| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xfeff ; [CPU_FPU] |368| 
        LSL       AL,8                  ; [CPU_ALU] |368| 
        OR        AL,AH                 ; [CPU_ALU] |368| 
        MOV       @$BLOCKED(_DmaRegs)+128,AL ; [CPU_ALU] |368| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |369| 
        ANDB      AL,#0x01              ; [CPU_ALU] |369| 
        LSL       AL,10                 ; [CPU_ALU] |369| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xfbff ; [CPU_FPU] |369| 
        OR        AL,AH                 ; [CPU_ALU] |369| 
        MOV       @$BLOCKED(_DmaRegs)+128,AL ; [CPU_ALU] |369| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |370| 
        ANDB      AL,#0x01              ; [CPU_ALU] |370| 
        LSL       AL,11                 ; [CPU_ALU] |370| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xf7ff ; [CPU_FPU] |370| 
        OR        AL,AH                 ; [CPU_ALU] |370| 
        MOV       @$BLOCKED(_DmaRegs)+128,AL ; [CPU_ALU] |370| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |371| 
        ANDB      AL,#0x01              ; [CPU_ALU] |371| 
        LSL       AL,7                  ; [CPU_ALU] |371| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xff7f ; [CPU_FPU] |371| 
        OR        AL,AH                 ; [CPU_ALU] |371| 
        MOV       @$BLOCKED(_DmaRegs)+128,AL ; [CPU_ALU] |371| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |372| 
        ANDB      AL,#0x01              ; [CPU_ALU] |372| 
        LSL       AL,14                 ; [CPU_ALU] |372| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xbfff ; [CPU_FPU] |372| 
...
;     | o CPU at beginning/end of transfer                                     
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |373| 
        ANDB      AL,#0x01              ; [CPU_ALU] |373| 
        LSL       AL,9                  ; [CPU_ALU] |373| 
        AND       AH,@$BLOCKED(_DmaRegs)+128,#0xfdff ; [CPU_FPU] |373| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+128,#0x7fff ; [CPU_ALU] |374| 
        MOVZ      AR6,AL                ; [CPU_ALU] |374| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |374| 
        OR        AL,AR6                ; [CPU_ALU] |374| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+129,#0x0010 ; [CPU_ALU] |377| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+129,#0x0080 ; [CPU_ALU] |378| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+14   ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0008 ; [CPU_ALU] |381| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+129,#0x0001 ; [CPU_ALU] |391| 
...
$C$DW$210	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$210, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOVL      *-SP[4],XAR5          ; [CPU_ALU] |397| 
        MOVL      *-SP[2],XAR4          ; [CPU_ALU] |397| 
...
;----------------------------------------------------------------------
        ...
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |401| 
        MOVL      @$BLOCKED(_DmaRegs)+176,ACC ; [CPU_ALU] |401| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+178,ACC ; [CPU_ALU] |402| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |405| 
        MOVL      @$BLOCKED(_DmaRegs)+184,ACC ; [CPU_ALU] |405| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+186,ACC ; [CPU_ALU] |406| 
...
$C$DW$218	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$218, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |413| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |413| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |413| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+162,AL ; [CPU_ALU] |418| 
...
;     |  addr between each word x-ferred                                       
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |419| 
        MOV       @$BLOCKED(_DmaRegs)+164,AL ; [CPU_ALU] |419| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+165,AL ; [CPU_ALU] |420| 
...
$C$DW$226	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$226, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |426| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |426| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+166,AL ; [CPU_ALU] |431| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |432| 
        MOV       @$BLOCKED(_DmaRegs)+168,AL ; [CPU_ALU] |432| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |433| 
        MOV       @$BLOCKED(_DmaRegs)+169,AL ; [CPU_ALU] |433| 
...
$C$DW$236	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$236, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |439| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |439| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |439| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+170,AL ; [CPU_ALU] |444| 
...
;     | wrap                                                                   
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |445| 
        MOV       @$BLOCKED(_DmaRegs)+172,AL ; [CPU_ALU] |445| 
...
;     |  address after N bursts                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |447| 
        MOV       @$BLOCKED(_DmaRegs)+173,AL ; [CPU_ALU] |447| 
...
;     | tion wrap                                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |448| 
        MOV       @$BLOCKED(_DmaRegs)+175,AL ; [CPU_ALU] |448| 
...
$C$DW$252	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$252, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |455| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |455| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |455| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |455| 
...
;----------------------------------------------------------------------
        ...
        MOV       AH,@$BLOCKED(_DmaClaSrcSelRegs)+24 ; [CPU_ALU] |459| 
        MOVB      AH,AL.LSB             ; [CPU_ALU] |459| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+24,AH ; [CPU_ALU] |459| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+160,#0xffe0 ; [CPU_ALU] |460| 
        ORB       AL,#0x05              ; [CPU_ALU] |460| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |460| 
...
;     |  enable                                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |461| 
        ANDB      AL,#0x01              ; [CPU_ALU] |461| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xfeff ; [CPU_FPU] |461| 
        LSL       AL,8                  ; [CPU_ALU] |461| 
        OR        AL,AH                 ; [CPU_ALU] |461| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |461| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |462| 
        LSL       AL,10                 ; [CPU_ALU] |462| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xfbff ; [CPU_FPU] |462| 
        OR        AL,AH                 ; [CPU_ALU] |462| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |462| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |463| 
        ANDB      AL,#0x01              ; [CPU_ALU] |463| 
        LSL       AL,11                 ; [CPU_ALU] |463| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xf7ff ; [CPU_FPU] |463| 
        OR        AL,AH                 ; [CPU_ALU] |463| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |463| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |464| 
        ANDB      AL,#0x01              ; [CPU_ALU] |464| 
        LSL       AL,7                  ; [CPU_ALU] |464| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xff7f ; [CPU_FPU] |464| 
        OR        AL,AH                 ; [CPU_ALU] |464| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |464| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |465| 
        ANDB      AL,#0x01              ; [CPU_ALU] |465| 
        LSL       AL,14                 ; [CPU_ALU] |465| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xbfff ; [CPU_FPU] |465| 
        OR        AL,AH                 ; [CPU_ALU] |465| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |465| 
...
;     | o CPU at beginning/end of transfer                                     
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |466| 
        ANDB      AL,#0x01              ; [CPU_ALU] |466| 
        LSL       AL,9                  ; [CPU_ALU] |466| 
        AND       AH,@$BLOCKED(_DmaRegs)+160,#0xfdff ; [CPU_FPU] |466| 
        OR        AL,AH                 ; [CPU_ALU] |466| 
        MOV       @$BLOCKED(_DmaRegs)+160,AL ; [CPU_ALU] |466| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+160,#0x7fff ; [CPU_ALU] |467| 
        MOVZ      AR6,AL                ; [CPU_ALU] |467| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |467| 
        OR        AL,AR6                ; [CPU_ALU] |467| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+161,#0x0010 ; [CPU_ALU] |470| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+161,#0x0080 ; [CPU_ALU] |471| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+14   ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0010 ; [CPU_ALU] |474| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+161,#0x0001 ; [CPU_ALU] |483| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+208,ACC ; [CPU_ALU] |494| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+210,ACC ; [CPU_ALU] |495| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |498| 
        MOVL      @$BLOCKED(_DmaRegs)+216,ACC ; [CPU_ALU] |498| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+218,ACC ; [CPU_ALU] |499| 
...
$C$DW$268	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$268, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[3],AR4           ; [CPU_ALU] |506| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |506| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |506| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+194,AL ; [CPU_ALU] |510| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |511| 
        MOV       @$BLOCKED(_DmaRegs)+196,AL ; [CPU_ALU] |511| 
...
;     |  addr between each word x-ferred                                       
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |512| 
        MOV       @$BLOCKED(_DmaRegs)+197,AL ; [CPU_ALU] |512| 
...
$C$DW$276	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$276, DW_AT_location[DW_OP_breg20 -3]
        ...
        MOV       *-SP[2],AH            ; [CPU_ALU] |519| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |519| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+198,AL ; [CPU_ALU] |523| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |524| 
        MOV       @$BLOCKED(_DmaRegs)+200,AL ; [CPU_ALU] |524| 
...
;     |  ignored when WRAP occurs                                              
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |525| 
        MOV       @$BLOCKED(_DmaRegs)+201,AL ; [CPU_ALU] |525| 
...
$C$DW$286	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$286, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |531| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |531| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |531| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |531| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+202,AL ; [CPU_ALU] |535| 
...
;     | wrap                                                                   
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |536| 
        MOV       @$BLOCKED(_DmaRegs)+204,AL ; [CPU_ALU] |536| 
...
;     |  address after N bursts                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |538| 
        MOV       @$BLOCKED(_DmaRegs)+205,AL ; [CPU_ALU] |538| 
...
;----------------------------------------------------------------------
        ...
        MOV       @$BLOCKED(_DmaRegs)+207,AL ; [CPU_ALU] |539| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaClaSrcSelRegs+24 ; [CPU_ARAU] 
        MOV       AL,@$BLOCKED(_DmaClaSrcSelRegs)+24 ; [CPU_ALU] |550| 
        MOV       AH,*-SP[1]            ; [CPU_ALU] |550| 
        MOVB      AL.MSB,AH             ; [CPU_ALU] |550| 
        MOV       @$BLOCKED(_DmaClaSrcSelRegs)+24,AL ; [CPU_ALU] |550| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_DmaRegs)+192,#0xffe0 ; [CPU_ALU] |551| 
        ORB       AL,#0x06              ; [CPU_ALU] |551| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |551| 
...
;     |  enable                                                                
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |552| 
        ANDB      AL,#0x01              ; [CPU_ALU] |552| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xfeff ; [CPU_FPU] |552| 
        LSL       AL,8                  ; [CPU_ALU] |552| 
        OR        AL,AH                 ; [CPU_ALU] |552| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |552| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |553| 
        ANDB      AL,#0x01              ; [CPU_ALU] |553| 
        LSL       AL,10                 ; [CPU_ALU] |553| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xfbff ; [CPU_FPU] |553| 
        OR        AL,AH                 ; [CPU_ALU] |553| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |553| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AL,#0x01              ; [CPU_ALU] |554| 
        LSL       AL,11                 ; [CPU_ALU] |554| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xf7ff ; [CPU_FPU] |554| 
        OR        AL,AH                 ; [CPU_ALU] |554| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |554| 
...
;     | verflow interrupt                                                      
;----------------------------------------------------------------------
        MOV       AL,*-SP[9]            ; [CPU_ALU] |555| 
        ANDB      AL,#0x01              ; [CPU_ALU] |555| 
        LSL       AL,7                  ; [CPU_ALU] |555| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xff7f ; [CPU_FPU] |555| 
        OR        AL,AH                 ; [CPU_ALU] |555| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |555| 
...
;     | ize transfers                                                          
;----------------------------------------------------------------------
        MOV       AL,*-SP[10]           ; [CPU_ALU] |556| 
        ANDB      AL,#0x01              ; [CPU_ALU] |556| 
        LSL       AL,14                 ; [CPU_ALU] |556| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xbfff ; [CPU_FPU] |556| 
        OR        AL,AH                 ; [CPU_ALU] |556| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |556| 
...
;     | o CPU at beginning/end of transfer                                     
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |557| 
        ANDB      AL,#0x01              ; [CPU_ALU] |557| 
        LSL       AL,9                  ; [CPU_ALU] |557| 
        AND       AH,@$BLOCKED(_DmaRegs)+192,#0xfdff ; [CPU_FPU] |557| 
        OR        AL,AH                 ; [CPU_ALU] |557| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |557| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_DmaRegs)+192,#0x7fff ; [CPU_ALU] |558| 
        MOVZ      AR6,AL                ; [CPU_ALU] |558| 
        MOV       ACC,*-SP[12] << #15   ; [CPU_ALU] |558| 
        OR        AL,AR6                ; [CPU_ALU] |558| 
        MOV       @$BLOCKED(_DmaRegs)+192,AL ; [CPU_ALU] |558| 
...
;     | nterrupt flags                                                         
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+193,#0x0010 ; [CPU_ALU] |561| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_DmaRegs)+193,#0x0080 ; [CPU_ALU] |562| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+14   ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+14,#0x0020 ; [CPU_ALU] |565| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_DmaRegs)+193,#0x0001 ; [CPU_ALU] |574| 
...
$C$DW$310	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$310, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOVL      *-SP[4],XAR5          ; [CPU_ALU] |580| 
        MOVL      *-SP[2],XAR4          ; [CPU_ALU] |580| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+48       ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |583| 
        MOVL      @$BLOCKED(_DmaRegs)+48,ACC ; [CPU_ALU] |583| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+50,ACC ; [CPU_ALU] |584| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |587| 
        MOVL      @$BLOCKED(_DmaRegs)+56,ACC ; [CPU_ALU] |587| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+58,ACC ; [CPU_ALU] |588| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+80       ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |598| 
        MOVL      @$BLOCKED(_DmaRegs)+80,ACC ; [CPU_ALU] |598| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+82,ACC ; [CPU_ALU] |599| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |602| 
        MOVL      @$BLOCKED(_DmaRegs)+88,ACC ; [CPU_ALU] |602| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+90,ACC ; [CPU_ALU] |603| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+112      ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |612| 
        MOVL      @$BLOCKED(_DmaRegs)+112,ACC ; [CPU_ALU] |612| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+114,ACC ; [CPU_ALU] |613| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+120,ACC ; [CPU_ALU] |616| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+122,ACC ; [CPU_ALU] |617| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+144      ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |626| 
        MOVL      @$BLOCKED(_DmaRegs)+144,ACC ; [CPU_ALU] |626| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+146,ACC ; [CPU_ALU] |627| 
...
;     | inning of destination buffer                                           
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |630| 
        MOVL      @$BLOCKED(_DmaRegs)+152,ACC ; [CPU_ALU] |630| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+154,ACC ; [CPU_ALU] |631| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+176      ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |640| 
        MOVL      @$BLOCKED(_DmaRegs)+176,ACC ; [CPU_ALU] |640| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+178,ACC ; [CPU_ALU] |641| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+184,ACC ; [CPU_ALU] |644| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+186,ACC ; [CPU_ALU] |645| 
...
$C$DW$340	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$340, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOVL      *-SP[4],XAR5          ; [CPU_ALU] |651| 
        MOVL      *-SP[2],XAR4          ; [CPU_ALU] |651| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_DmaRegs+208      ; [CPU_ARAU] 
        MOVL      ACC,*-SP[4]           ; [CPU_ALU] |654| 
        MOVL      @$BLOCKED(_DmaRegs)+208,ACC ; [CPU_ALU] |654| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+210,ACC ; [CPU_ALU] |655| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DmaRegs)+216,ACC ; [CPU_ALU] |658| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_DmaRegs)+218,ACC ; [CPU_ALU] |659| 
...
$C$DW$1006	.dwtag  DW_TAG_TI_assign_register
	...
	.dwattr $C$DW$1006, DW_AT_location[DW_OP_regx 0x2f]

$C$DW$1007	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1007, DW_AT_name("R2H")
	.dwattr $C$DW$1007, DW_AT_location[DW_OP_regx 0x33]

$C$DW$1008	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1008, DW_AT_name("R3H")
	.dwattr $C$DW$1008, DW_AT_location[DW_OP_regx 0x37]

$C$DW$1009	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1009, DW_AT_name("R4H")
	.dwattr $C$DW$1009, DW_AT_location[DW_OP_regx 0x3b]

$C$DW$1010	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1010, DW_AT_name("R5H")
	.dwattr $C$DW$1010, DW_AT_location[DW_OP_regx 0x3f]

$C$DW$1011	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1011, DW_AT_name("R6H")
	.dwattr $C$DW$1011, DW_AT_location[DW_OP_regx 0x43]

$C$DW$1012	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1012, DW_AT_name("R7H")
	.dwattr $C$DW$1012, DW_AT_location[DW_OP_regx 0x47]

$C$DW$1013	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1013, DW_AT_name("RB")
	.dwattr $C$DW$1013, DW_AT_location[DW_OP_regx 0x4a]

$C$DW$1014	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1014, DW_AT_name("STF")
	.dwattr $C$DW$1014, DW_AT_location[DW_OP_regx 0x28]

$C$DW$1015	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1015, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$1015, DW_AT_location[DW_OP_reg27]

$C$DW$1016	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$1016, DW_AT_name("STF_HWDIV")
	.dwattr $C$DW$1016, DW_AT_location[DW_OP_regx 0x4f]
