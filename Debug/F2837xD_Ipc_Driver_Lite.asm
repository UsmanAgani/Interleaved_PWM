...
;* Date/Time created: Thu Feb 29 14:44:42 2024                 *
;***************************************************************
...
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{53AF42BA-3314-4027-9B7C-6BF02EA791CE} 
	.sect	".text"
	.clink
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |78| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |78| 
        TEST      ACC                   ; [CPU_ALU] |78| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |85| 
        CMPB      AL,#1                 ; [CPU_ALU] |85| 
        B         $C$L2,NEQ             ; [CPU_ALU] |85| 
        ; branchcc occurs ; [] |85| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+22 ; [CPU_ALU] |87| 
        MOV       *+XAR4[0],AL          ; [CPU_ALU] |87| 
        B         $C$L3,UNC             ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L2:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |89| 
        B         $C$L3,NEQ             ; [CPU_ALU] |89| 
        ; branchcc occurs ; [] |89| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+22 ; [CPU_ALU] |91| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |91| 
$C$L3:    
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |130| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |130| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |130| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |130| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |130| 
        TEST      ACC                   ; [CPU_ALU] |130| 
        B         $C$L5,EQ              ; [CPU_ALU] |130| 
        ; branchcc occurs ; [] |130| 
...
;----------------------------------------------------------------------
        ...
        CMPB      AL,#1                 ; [CPU_ALU] |137| 
        B         $C$L6,NEQ             ; [CPU_ALU] |137| 
        ; branchcc occurs ; [] |137| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#7                ; [CPU_ALU] |139| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |139| 
        B         $C$L7,UNC             ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L6:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |141| 
        B         $C$L7,NEQ             ; [CPU_ALU] |141| 
        ; branchcc occurs ; [] |141| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#8                ; [CPU_ALU] |143| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |143| 
$C$L7:    
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |145| 
...
;----------------------------------------------------------------------
        ...
        SUBB      XAR4,#10              ; [CPU_ARAU] |148| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |148| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |148| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |148| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |148| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |148| 
...
;----------------------------------------------------------------------
        ...
        OR        AL,*-SP[2]            ; [CPU_ALU] |192| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |192| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |192| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |192| 
        TEST      ACC                   ; [CPU_ALU] |192| 
        B         $C$L9,EQ              ; [CPU_ALU] |192| 
        ; branchcc occurs ; [] |192| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#1                ; [CPU_ALU] |201| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |201| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |202| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |203| 
        ANDB      AH,#0                 ; [CPU_ALU] |203| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |203| 
        B         $C$L11,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L10:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |205| 
        B         $C$L11,NEQ            ; [CPU_ALU] |205| 
        ; branchcc occurs ; [] |205| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#2                ; [CPU_ALU] |208| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |208| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |209| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |209| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |210| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |210| 
$C$L11:    
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |214| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |214| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |214| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |214| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |214| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |214| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |214| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |214| 
...
;----------------------------------------------------------------------
        ...
        OR        AL,*-SP[2]            ; [CPU_ALU] |259| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |259| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |259| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |259| 
        TEST      ACC                   ; [CPU_ALU] |259| 
        B         $C$L13,EQ             ; [CPU_ALU] |259| 
        ; branchcc occurs ; [] |259| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |265| 
        CMPB      AL,#1                 ; [CPU_ALU] |265| 
        B         $C$L14,NEQ            ; [CPU_ALU] |265| 
        ; branchcc occurs ; [] |265| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#9                ; [CPU_ALU] |268| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |268| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |269| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |269| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AH,#0                 ; [CPU_ALU] |270| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |270| 
        B         $C$L15,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L14:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#10               ; [CPU_ALU] |275| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |275| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |276| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |277| 
$C$L15:    
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |281| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |281| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |281| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |281| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |281| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |281| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |281| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |281| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[12]          ; [CPU_ALU] |325| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |325| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |325| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |325| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |325| 
        TEST      ACC                   ; [CPU_ALU] |325| 
        B         $C$L17,EQ             ; [CPU_ALU] |325| 
        ; branchcc occurs ; [] |325| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |331| 
        CMPB      AL,#1                 ; [CPU_ALU] |331| 
        B         $C$L18,NEQ            ; [CPU_ALU] |331| 
        ; branchcc occurs ; [] |331| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#3                ; [CPU_ALU] |334| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |334| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |335| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |335| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |336| 
        ANDB      AH,#0                 ; [CPU_ALU] |336| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |336| 
        B         $C$L19,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L18:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |338| 
        B         $C$L19,NEQ            ; [CPU_ALU] |338| 
        ; branchcc occurs ; [] |338| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#4                ; [CPU_ALU] |341| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |341| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |342| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |342| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |343| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |343| 
$C$L19:    
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |347| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |347| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |347| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |347| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |347| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |347| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |347| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |347| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[12]          ; [CPU_ALU] |392| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |392| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |392| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |392| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |392| 
        TEST      ACC                   ; [CPU_ALU] |392| 
        B         $C$L21,EQ             ; [CPU_ALU] |392| 
        ; branchcc occurs ; [] |392| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#11               ; [CPU_ALU] |401| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |401| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |402| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |402| 
...
;----------------------------------------------------------------------
        ...
        ANDB      AH,#0                 ; [CPU_ALU] |403| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |403| 
        B         $C$L23,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L22:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |405| 
        B         $C$L23,NEQ            ; [CPU_ALU] |405| 
        ; branchcc occurs ; [] |405| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#12               ; [CPU_ALU] |408| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |408| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |409| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |409| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |410| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |410| 
$C$L23:    
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |414| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |414| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |414| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |414| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |414| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |414| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |414| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |414| 
...
;     | available.                                                             
;----------------------------------------------------------------------
        MOV       *-SP[3],AR4           ; [CPU_ALU] |449| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |449| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[12]          ; [CPU_ALU] |453| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |453| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |453| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |453| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |453| 
        TEST      ACC                   ; [CPU_ALU] |453| 
        B         $C$L25,EQ             ; [CPU_ALU] |453| 
        ; branchcc occurs ; [] |453| 
...
; 457 | else                                                                   
; 459 | // Set up data write command, address, and data. For 16-bit write, Mast
;     | er                                                                     
; 460 | // system will                                                         
; 461 | // look at lower 16-bits only.                                         
;----------------------------------------------------------------------
        MOVB      *-SP[4],#1,UNC        ; [CPU_ALU] |455| 
        B         $C$L28,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L25:    
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[3]            ; [CPU_ALU] |462| 
        CMPB      AL,#1                 ; [CPU_ALU] |462| 
        B         $C$L26,NEQ            ; [CPU_ALU] |462| 
        ; branchcc occurs ; [] |462| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#5                ; [CPU_ALU] |464| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |464| 
        B         $C$L27,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L26:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |466| 
        B         $C$L27,NEQ            ; [CPU_ALU] |466| 
        ; branchcc occurs ; [] |466| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#6                ; [CPU_ALU] |468| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |468| 
$C$L27:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |470| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |470| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |471| 
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |474| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |474| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |474| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |474| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |474| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |474| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |474| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |474| 
...
;     | available.                                                             
;----------------------------------------------------------------------
        MOV       *-SP[3],AR4           ; [CPU_ALU] |509| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |509| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[12]          ; [CPU_ALU] |513| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |513| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |513| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |513| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |513| 
        TEST      ACC                   ; [CPU_ALU] |513| 
        B         $C$L29,EQ             ; [CPU_ALU] |513| 
        ; branchcc occurs ; [] |513| 
...
; 517 | else                                                                   
; 519 | // Set up data write command, address, and data. For 16-bit write, Mast
;     | er                                                                     
; 520 | // system will                                                         
; 521 | // look at lower 16-bits only.                                         
;----------------------------------------------------------------------
        MOVB      *-SP[4],#1,UNC        ; [CPU_ALU] |515| 
        B         $C$L32,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L29:    
...
;----------------------------------------------------------------------
        ...
        CMPB      AL,#1                 ; [CPU_ALU] |522| 
        B         $C$L30,NEQ            ; [CPU_ALU] |522| 
        ; branchcc occurs ; [] |522| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#13               ; [CPU_ALU] |524| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |524| 
        B         $C$L31,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L30:    
...
;----------------------------------------------------------------------
        CMPB      AL,#2                 ; [CPU_ALU] |526| 
        B         $C$L31,NEQ            ; [CPU_ALU] |526| 
        ; branchcc occurs ; [] |526| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#14               ; [CPU_ALU] |528| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |528| 
$C$L31:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |530| 
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |530| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |531| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |531| 
...
;----------------------------------------------------------------------
        MOVZ      AR4,SP                ; [CPU_ALU] |534| 
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |534| 
        SUBB      XAR4,#12              ; [CPU_ARAU] |534| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |534| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |534| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |534| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |534| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |534| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_IpcRegs+8        ; [CPU_ARAU] 
        MOVL      ACC,*-SP[12]          ; [CPU_ALU] |569| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |569| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |569| 
        AND       AL,@$BLOCKED(_IpcRegs)+8 ; [CPU_ALU] |569| 
        AND       AH,@$BLOCKED(_IpcRegs)+9 ; [CPU_ALU] |569| 
        TEST      ACC                   ; [CPU_ALU] |569| 
        B         $C$L33,EQ             ; [CPU_ALU] |569| 
        ; branchcc occurs ; [] |569| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#18               ; [CPU_ALU] |576| 
        MOVL      @$BLOCKED(_IpcRegs)+16,ACC ; [CPU_ALU] |576| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_IpcRegs)+18,ACC ; [CPU_ALU] |577| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |578| 
        MOVL      @$BLOCKED(_IpcRegs)+20,ACC ; [CPU_ALU] |578| 
...
;----------------------------------------------------------------------
        ...
        SUBB      XAR4,#12              ; [CPU_ARAU] |581| 
        OR        AL,@$BLOCKED(_IpcRegs)+4 ; [CPU_ALU] |581| 
        OR        AL,*+XAR4[0]          ; [CPU_ALU] |581| 
        OR        AH,@$BLOCKED(_IpcRegs)+5 ; [CPU_ALU] |581| 
        OR        AH,*+XAR4[1]          ; [CPU_ALU] |581| 
        MOVL      @$BLOCKED(_IpcRegs)+4,ACC ; [CPU_ALU] |581| 
...
; 620 | uint16_t status;                                                       
;----------------------------------------------------------------------
        MOV       *-SP[11],AR4          ; [CPU_ALU] |619| 
        MOVL      *-SP[8],ACC           ; [CPU_ALU] |619| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,#_MemCfgRegs+68  ; [CPU_ARAU] |621| 
        MOVL      *-SP[10],XAR4         ; [CPU_ALU] |621| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[11]           ; [CPU_ALU] |622| 
        B         $C$L35,NEQ            ; [CPU_ALU] |622| 
        ; branchcc occurs ; [] |622| 
...
; 627 |                                   ulStatusFlag);                       
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |624| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |624| 
        MOVB      XAR4,#2               ; [CPU_ALU] |624| 
        MOVL      ACC,*-SP[16]          ; [CPU_ALU] |624| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |624| 
        MOVL      ACC,*-SP[18]          ; [CPU_ALU] |624| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |624| 
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |624| 
$C$DW$98	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$98, DW_AT_low_pc(0x00)
	.dwattr $C$DW$98, DW_AT_name("_IPCLiteLtoRSetBits_Protected")
	.dwattr $C$DW$98, DW_AT_TI_call

        LCR       #_IPCLiteLtoRSetBits_Protected ; [CPU_ALU] |624| 
        ; call occurs [#_IPCLiteLtoRSetBits_Protected] ; [] |624| 
        MOV       *-SP[12],AL           ; [CPU_ALU] |624| 
        B         $C$L36,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L35:    
...
; 634 |                                     ulStatusFlag);                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |631| 
        MOVL      *-SP[2],ACC           ; [CPU_ALU] |631| 
        MOVB      XAR4,#2               ; [CPU_ALU] |631| 
        MOVL      ACC,*-SP[16]          ; [CPU_ALU] |631| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |631| 
        MOVL      ACC,*-SP[18]          ; [CPU_ALU] |631| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |631| 
...
$C$DW$99	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$99, DW_AT_TI_call
        ...
        LCR       #_IPCLiteLtoRClearBits_Protected ; [CPU_ALU] |631| 
        ; call occurs [#_IPCLiteLtoRClearBits_Protected] ; [] |631| 
        MOV       *-SP[12],AL           ; [CPU_ALU] |631| 
$C$L36:    
...
; 670 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |662| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |662| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |662| 
        TEST      ACC                   ; [CPU_ALU] |662| 
        B         $C$L37,EQ             ; [CPU_ALU] |662| 
        ; branchcc occurs ; [] |662| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#7                ; [CPU_ALU] |671| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |671| 
        B         $C$L38,NEQ            ; [CPU_ALU] |671| 
        ; branchcc occurs ; [] |671| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |674| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |674| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |675| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |675| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |675| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |676| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |676| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |676| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |676| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |676| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |676| 
        B         $C$L40,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L38:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#8                ; [CPU_ALU] |678| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |678| 
        B         $C$L39,NEQ            ; [CPU_ALU] |678| 
        ; branchcc occurs ; [] |678| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |680| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |680| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |681| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |681| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |681| 
...
; 687 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |682| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |682| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |682| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |682| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |682| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |682| 
        B         $C$L40,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L39:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |689| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |689| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |689| 
...
; 725 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |717| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |717| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |717| 
        TEST      ACC                   ; [CPU_ALU] |717| 
        B         $C$L41,EQ             ; [CPU_ALU] |717| 
        ; branchcc occurs ; [] |717| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#1                ; [CPU_ALU] |726| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |726| 
        B         $C$L42,NEQ            ; [CPU_ALU] |726| 
        ; branchcc occurs ; [] |726| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |728| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |729| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |729| 
        OR        *+XAR4[0],AL          ; [CPU_ALU] |729| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |730| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |730| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |730| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |732| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |732| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |732| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |732| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |732| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |732| 
        B         $C$L44,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L42:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#2                ; [CPU_ALU] |734| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |734| 
        B         $C$L43,NEQ            ; [CPU_ALU] |734| 
        ; branchcc occurs ; [] |734| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |736| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |736| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |737| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |737| 
        OR        *+XAR4[0],AL          ; [CPU_ALU] |737| 
        OR        *+XAR4[1],AH          ; [CPU_ALU] |737| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |738| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |738| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |738| 
...
; 745 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |740| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |740| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |740| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |740| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |740| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |740| 
        B         $C$L44,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L43:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |747| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |747| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |747| 
...
;----------------------------------------------------------------------
        ...
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |775| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |775| 
        TEST      ACC                   ; [CPU_ALU] |775| 
        B         $C$L45,EQ             ; [CPU_ALU] |775| 
        ; branchcc occurs ; [] |775| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#9                ; [CPU_ALU] |789| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |789| 
        B         $C$L46,NEQ            ; [CPU_ALU] |789| 
        ; branchcc occurs ; [] |789| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |791| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |792| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |792| 
        OR        *+XAR4[0],AL          ; [CPU_ALU] |792| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |793| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |793| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |793| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |795| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |795| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |795| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |795| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |795| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |795| 
        B         $C$L48,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L46:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#10               ; [CPU_ALU] |797| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |797| 
        B         $C$L47,NEQ            ; [CPU_ALU] |797| 
        ; branchcc occurs ; [] |797| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |799| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |799| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |800| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |800| 
        OR        *+XAR4[0],AL          ; [CPU_ALU] |800| 
        OR        *+XAR4[1],AH          ; [CPU_ALU] |800| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |801| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |801| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |801| 
...
; 809 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |803| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |803| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |803| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |803| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |803| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |803| 
        B         $C$L48,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L47:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |811| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |811| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |811| 
$C$L48:    
...
; 850 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |842| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |842| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |842| 
        TEST      ACC                   ; [CPU_ALU] |842| 
        B         $C$L49,EQ             ; [CPU_ALU] |842| 
        ; branchcc occurs ; [] |842| 
...
;----------------------------------------------------------------------
        ...
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |851| 
        B         $C$L50,NEQ            ; [CPU_ALU] |851| 
        ; branchcc occurs ; [] |851| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |853| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |853| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |854| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |854| 
        NOT       AL                    ; [CPU_ALU] |854| 
        AND       *+XAR4[0],AL          ; [CPU_ALU] |854| 
...
;----------------------------------------------------------------------
        ...
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |855| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |855| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |857| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |857| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |857| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |857| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |857| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |857| 
        B         $C$L52,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L50:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#4                ; [CPU_ALU] |859| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |859| 
        B         $C$L51,NEQ            ; [CPU_ALU] |859| 
        ; branchcc occurs ; [] |859| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |861| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |861| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |862| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |862| 
        NOT       ACC                   ; [CPU_ALU] |862| 
        AND       *+XAR4[0],AL          ; [CPU_ALU] |862| 
        AND       *+XAR4[1],AH          ; [CPU_ALU] |862| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |863| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |863| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |863| 
...
; 871 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |865| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |865| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |865| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |865| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |865| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |865| 
        B         $C$L52,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L51:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |873| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |873| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |873| 
...
; 911 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |901| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |901| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |901| 
        TEST      ACC                   ; [CPU_ALU] |901| 
        B         $C$L53,EQ             ; [CPU_ALU] |901| 
        ; branchcc occurs ; [] |901| 
...
;----------------------------------------------------------------------
        ...
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |914| 
        B         $C$L54,NEQ            ; [CPU_ALU] |914| 
        ; branchcc occurs ; [] |914| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |917| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |917| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |918| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |918| 
        NOT       AL                    ; [CPU_ALU] |918| 
        AND       *+XAR4[0],AL          ; [CPU_ALU] |918| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |919| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |919| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |919| 
...
;----------------------------------------------------------------------
        ...
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |921| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |921| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |921| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |921| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |921| 
        B         $C$L56,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L54:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#12               ; [CPU_ALU] |923| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |923| 
        B         $C$L55,NEQ            ; [CPU_ALU] |923| 
        ; branchcc occurs ; [] |923| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |926| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |926| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |927| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |927| 
        NOT       ACC                   ; [CPU_ALU] |927| 
        AND       *+XAR4[0],AL          ; [CPU_ALU] |927| 
        AND       *+XAR4[1],AH          ; [CPU_ALU] |927| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |928| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |928| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |928| 
...
; 936 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |930| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |930| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |930| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |930| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |930| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |930| 
        B         $C$L56,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L55:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |938| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |938| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |938| 
$C$L56:    
...
; 973 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |965| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |965| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |965| 
        TEST      ACC                   ; [CPU_ALU] |965| 
        B         $C$L57,EQ             ; [CPU_ALU] |965| 
        ; branchcc occurs ; [] |965| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#5                ; [CPU_ALU] |974| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |974| 
        B         $C$L58,NEQ            ; [CPU_ALU] |974| 
        ; branchcc occurs ; [] |974| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |976| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |976| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |977| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |977| 
        MOV       *+XAR4[0],AL          ; [CPU_ALU] |977| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |978| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |978| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |978| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |980| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |980| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |980| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |980| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |980| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |980| 
        B         $C$L60,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L58:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#6                ; [CPU_ALU] |982| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |982| 
        B         $C$L59,NEQ            ; [CPU_ALU] |982| 
        ; branchcc occurs ; [] |982| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |984| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |984| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |985| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |985| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |985| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |986| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |986| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |986| 
...
; 995 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |988| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |988| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |988| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |988| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |988| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |988| 
        B         $C$L60,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L59:    
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |997| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |997| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |997| 
...
; 1032 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |1023| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |1023| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |1023| 
        TEST      ACC                   ; [CPU_ALU] |1023| 
        B         $C$L61,EQ             ; [CPU_ALU] |1023| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#13               ; [CPU_ALU] |1035| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |1035| 
        B         $C$L62,NEQ            ; [CPU_ALU] |1035| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |1037| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |1037| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |1038| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |1038| 
        MOV       *+XAR4[0],AL          ; [CPU_ALU] |1038| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[6]          ; [CPU_ALU] |1039| 
        MOVU      ACC,*+XAR4[0]         ; [CPU_ALU] |1039| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |1039| 
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |1041| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |1041| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |1041| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |1041| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |1041| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |1041| 
        B         $C$L64,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L62:    
...
;----------------------------------------------------------------------
        MOVB      ACC,#14               ; [CPU_ALU] |1043| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |1043| 
        B         $C$L63,NEQ            ; [CPU_ALU] |1043| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |1045| 
        MOVL      *-SP[4],ACC           ; [CPU_ALU] |1045| 
...
;----------------------------------------------------------------------
        ...
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |1046| 
        MOVL      *+XAR4[0],ACC         ; [CPU_ALU] |1046| 
...
;----------------------------------------------------------------------
        MOVL      XAR4,*-SP[4]          ; [CPU_ALU] |1047| 
        MOVL      ACC,*+XAR4[0]         ; [CPU_ALU] |1047| 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |1047| 
...
; 1056 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[10]          ; [CPU_ALU] |1049| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |1049| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |1049| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |1049| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |1049| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |1049| 
        B         $C$L64,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L63:    
...
; 1062 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |1058| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |1058| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |1058| 
$C$L64:    
...
; 1094 | //                                                                     
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |1085| 
        MOVW      DP,#_IpcRegs+2        ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_IpcRegs)+2 ; [CPU_ALU] |1085| 
        AND       AH,@$BLOCKED(_IpcRegs)+3 ; [CPU_ALU] |1085| 
        TEST      ACC                   ; [CPU_ALU] |1085| 
        B         $C$L65,EQ             ; [CPU_ALU] |1085| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#18               ; [CPU_ALU] |1095| 
        CMPL      ACC,@$BLOCKED(_IpcRegs)+24 ; [CPU_ALU] |1095| 
        B         $C$L66,NEQ            ; [CPU_ALU] |1095| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_IpcRegs)+26 ; [CPU_ALU] |1097| 
...
;----------------------------------------------------------------------
        MOVL      XAR7,*-SP[4]          ; [CPU_ALU] |1098| 
        MOVL      ACC,@$BLOCKED(_IpcRegs)+28 ; [CPU_ALU] |1098| 
$C$DW$156	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$156, DW_AT_low_pc(0x00)
	.dwattr $C$DW$156, DW_AT_TI_call
	.dwattr $C$DW$156, DW_AT_TI_indirect

        LCR       *XAR7                 ; [CPU_ALU] |1098| 
        ; call occurs [XAR7] ; [] |1098| 
        MOVW      DP,#_IpcRegs+30       ; [CPU_ARAU] 
        MOVL      @$BLOCKED(_IpcRegs)+30,ACC ; [CPU_ALU] |1098| 
...
; 1106 | else                                                                   
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[8]           ; [CPU_ALU] |1100| 
        OR        AL,@$BLOCKED(_IpcRegs) ; [CPU_ALU] |1100| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |1100| 
        OR        AH,@$BLOCKED(_IpcRegs)+1 ; [CPU_ALU] |1100| 
        OR        AH,*-SP[1]            ; [CPU_ALU] |1100| 
        MOVL      @$BLOCKED(_IpcRegs),ACC ; [CPU_ALU] |1100| 
	.dwendtag $C$DW$154
...
;----------------------------------------------------------------------
        MOVL      ACC,*-SP[2]           ; [CPU_ALU] |1108| 
        OR        @$BLOCKED(_IpcRegs),AL ; [CPU_ALU] |1108| 
        OR        @$BLOCKED(_IpcRegs)+1,AH ; [CPU_ALU] |1108| 
...
$C$DW$743	.dwtag  DW_TAG_formal_parameter
	.dwattr $C$DW$743, DW_AT_type(*$C$DW$T$102)
...
$C$DW$762	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$762, DW_AT_name("EALLOW")
	.dwattr $C$DW$762, DW_AT_location[DW_OP_regx 0x4e]

$C$DW$763	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$763, DW_AT_name("INTM")
	.dwattr $C$DW$763, DW_AT_location[DW_OP_regx 0x23]

$C$DW$764	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$764, DW_AT_name("IFR")
	.dwattr $C$DW$764, DW_AT_location[DW_OP_regx 0x24]

$C$DW$765	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$765, DW_AT_name("IER")
	.dwattr $C$DW$765, DW_AT_location[DW_OP_regx 0x25]

$C$DW$766	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$766, DW_AT_name("V")
	.dwattr $C$DW$766, DW_AT_location[DW_OP_regx 0x26]

$C$DW$767	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$767, DW_AT_name("PSEUDOH")
	.dwattr $C$DW$767, DW_AT_location[DW_OP_regx 0x4c]

$C$DW$768	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$768, DW_AT_name("VOL")
	.dwattr $C$DW$768, DW_AT_location[DW_OP_regx 0x4d]

$C$DW$769	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$769, DW_AT_name("AR0")
	.dwattr $C$DW$769, DW_AT_location[DW_OP_reg4]

$C$DW$770	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$770, DW_AT_name("XAR0")
	.dwattr $C$DW$770, DW_AT_location[DW_OP_reg5]

$C$DW$771	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$771, DW_AT_name("AR1")
	.dwattr $C$DW$771, DW_AT_location[DW_OP_reg6]

$C$DW$772	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$772, DW_AT_name("XAR1")
	.dwattr $C$DW$772, DW_AT_location[DW_OP_reg7]

$C$DW$773	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$773, DW_AT_name("AR2")
	.dwattr $C$DW$773, DW_AT_location[DW_OP_reg8]

$C$DW$774	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$774, DW_AT_name("XAR2")
	.dwattr $C$DW$774, DW_AT_location[DW_OP_reg9]

$C$DW$775	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$775, DW_AT_name("AR3")
	.dwattr $C$DW$775, DW_AT_location[DW_OP_reg10]

$C$DW$776	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$776, DW_AT_name("XAR3")
	.dwattr $C$DW$776, DW_AT_location[DW_OP_reg11]

$C$DW$777	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$777, DW_AT_name("AR4")
	.dwattr $C$DW$777, DW_AT_location[DW_OP_reg12]

$C$DW$778	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$778, DW_AT_name("XAR4")
	.dwattr $C$DW$778, DW_AT_location[DW_OP_reg13]

$C$DW$779	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$779, DW_AT_name("AR5")
	.dwattr $C$DW$779, DW_AT_location[DW_OP_reg14]

$C$DW$780	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$780, DW_AT_name("XAR5")
	.dwattr $C$DW$780, DW_AT_location[DW_OP_reg15]

$C$DW$781	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$781, DW_AT_name("AR6")
	.dwattr $C$DW$781, DW_AT_location[DW_OP_reg16]

$C$DW$782	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$782, DW_AT_name("XAR6")
	.dwattr $C$DW$782, DW_AT_location[DW_OP_reg17]

$C$DW$783	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$783, DW_AT_name("AR7")
	.dwattr $C$DW$783, DW_AT_location[DW_OP_reg18]

$C$DW$784	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$784, DW_AT_name("XAR7")
	.dwattr $C$DW$784, DW_AT_location[DW_OP_reg19]

$C$DW$785	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$785, DW_AT_name("R0H")
	.dwattr $C$DW$785, DW_AT_location[DW_OP_regx 0x2b]

$C$DW$786	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$786, DW_AT_name("R1H")
	.dwattr $C$DW$786, DW_AT_location[DW_OP_regx 0x2f]

$C$DW$787	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$787, DW_AT_name("R2H")
	.dwattr $C$DW$787, DW_AT_location[DW_OP_regx 0x33]

$C$DW$788	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$788, DW_AT_name("R3H")
	.dwattr $C$DW$788, DW_AT_location[DW_OP_regx 0x37]

$C$DW$789	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$789, DW_AT_name("R4H")
	.dwattr $C$DW$789, DW_AT_location[DW_OP_regx 0x3b]

$C$DW$790	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$790, DW_AT_name("R5H")
	.dwattr $C$DW$790, DW_AT_location[DW_OP_regx 0x3f]

$C$DW$791	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$791, DW_AT_name("R6H")
	.dwattr $C$DW$791, DW_AT_location[DW_OP_regx 0x43]

$C$DW$792	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$792, DW_AT_name("R7H")
	.dwattr $C$DW$792, DW_AT_location[DW_OP_regx 0x47]

$C$DW$793	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$793, DW_AT_name("RB")
	.dwattr $C$DW$793, DW_AT_location[DW_OP_regx 0x4a]

$C$DW$794	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$794, DW_AT_name("STF")
	.dwattr $C$DW$794, DW_AT_location[DW_OP_regx 0x28]

$C$DW$795	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$795, DW_AT_name("FPUHAZ")
	.dwattr $C$DW$795, DW_AT_location[DW_OP_reg27]

$C$DW$796	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$796, DW_AT_name("STF_HWDIV")
