...
;* Date/Time created: Thu Feb 29 14:44:43 2024                 *
;***************************************************************
...
$C$DW$5	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$5, DW_AT_type(*$C$DW$T$360)
...
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{0DD46535-825B-4DDB-BF41-6F843BB083BB} 
	.sect	".text"
	.clink
	.global	_InitSysCtrl
...
; 116 | #endif                                                                 
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+35,#0x0001 ; [CPU_ALU] |115| 
...
; 120 | #ifdef CPU1                                                            
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+35,#0x0004 ; [CPU_ALU] |118| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+36,#0x0001 ; [CPU_ALU] |121| 
...
; 123 | #endif                                                                 
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+36,#0x0002 ; [CPU_ALU] |122| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0001 ; [CPU_ALU] |125| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0002 ; [CPU_ALU] |126| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0004 ; [CPU_ALU] |127| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0008 ; [CPU_ALU] |128| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0010 ; [CPU_ALU] |129| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0020 ; [CPU_ALU] |130| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0040 ; [CPU_ALU] |131| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0080 ; [CPU_ALU] |132| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0100 ; [CPU_ALU] |133| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0200 ; [CPU_ALU] |134| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0400 ; [CPU_ALU] |135| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+38,#0x0800 ; [CPU_ALU] |136| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0001 ; [CPU_ALU] |138| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0002 ; [CPU_ALU] |139| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0004 ; [CPU_ALU] |140| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0008 ; [CPU_ALU] |141| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0010 ; [CPU_ALU] |142| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+40,#0x0020 ; [CPU_ALU] |143| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+42,#0x0001 ; [CPU_ALU] |145| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+42,#0x0002 ; [CPU_ALU] |146| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+42,#0x0004 ; [CPU_ALU] |147| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+46,#0x0001 ; [CPU_ALU] |149| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+46,#0x0002 ; [CPU_ALU] |150| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+48,#0x0001 ; [CPU_ALU] |152| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+48,#0x0002 ; [CPU_ALU] |153| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+48,#0x0004 ; [CPU_ALU] |154| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+48,#0x0008 ; [CPU_ALU] |155| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+50,#0x0001 ; [CPU_ALU] |157| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+50,#0x0002 ; [CPU_ALU] |158| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+50,#0x0004 ; [CPU_ALU] |159| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+52,#0x0001 ; [CPU_ALU] |161| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+52,#0x0002 ; [CPU_ALU] |162| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+54,#0x0001 ; [CPU_ALU] |164| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+54,#0x0002 ; [CPU_ALU] |165| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+56,#0x0001 ; [CPU_ALU] |167| 
...
; 170 | #ifdef CPU1                                                            
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+56,#0x0002 ; [CPU_ALU] |168| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+57,#0x0001 ; [CPU_ALU] |171| 
...
; 174 | #endif                                                                 
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+58,#0x0001 ; [CPU_ALU] |173| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+60,#0x0001 ; [CPU_ALU] |176| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+60,#0x0002 ; [CPU_ALU] |177| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+60,#0x0004 ; [CPU_ALU] |178| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+60,#0x0008 ; [CPU_ALU] |179| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0001 ; [CPU_ALU] |181| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0002 ; [CPU_ALU] |182| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0004 ; [CPU_ALU] |183| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0008 ; [CPU_ALU] |184| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0010 ; [CPU_ALU] |185| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0020 ; [CPU_ALU] |186| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0040 ; [CPU_ALU] |187| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+62,#0x0080 ; [CPU_ALU] |188| 
...
;----------------------------------------------------------------------
        ...
        OR        @$BLOCKED(_CpuSysRegs)+67,#0x0001 ; [CPU_ALU] |190| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+67,#0x0002 ; [CPU_ALU] |191| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_CpuSysRegs)+67,#0x0004 ; [CPU_ALU] |192| 
...
;----------------------------------------------------------------------
        ...
        MOVW      DP,#_CpuSysRegs+34    ; [CPU_ARAU] 
        MOVL      @$BLOCKED(_CpuSysRegs)+34,ACC ; [CPU_ALU] |201| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+36,ACC ; [CPU_ALU] |202| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+38,ACC ; [CPU_ALU] |203| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+40,ACC ; [CPU_ALU] |204| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+42,ACC ; [CPU_ALU] |205| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+46,ACC ; [CPU_ALU] |206| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+48,ACC ; [CPU_ALU] |207| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+50,ACC ; [CPU_ALU] |208| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+52,ACC ; [CPU_ALU] |209| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+54,ACC ; [CPU_ALU] |210| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+56,ACC ; [CPU_ALU] |211| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+58,ACC ; [CPU_ALU] |212| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+60,ACC ; [CPU_ALU] |213| 
...
;----------------------------------------------------------------------
        MOVL      @$BLOCKED(_CpuSysRegs)+62,ACC ; [CPU_ALU] |214| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_CpuSysRegs)+66,ACC ; [CPU_ALU] |215| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_Flash0CtrlRegs)+30,#0xff00 ; [CPU_ALU] |236| 
        ORB       AL,#0x14              ; [CPU_ALU] |236| 
        MOV       @$BLOCKED(_Flash0CtrlRegs)+30,AL ; [CPU_ALU] |236| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_Flash0CtrlRegs)+36,#0x0001 ; [CPU_ALU] |243| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_Flash0CtrlRegs)+32,#0x0003 ; [CPU_ALU] |244| 
...
;----------------------------------------------------------------------
        ...
        AND       @$BLOCKED(_Flash0CtrlRegs)+384,#0xfffd ; [CPU_ALU] |247| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_Flash0CtrlRegs)+384,#0xfffe ; [CPU_ALU] |248| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_Flash0CtrlRegs),#0xf0ff ; [CPU_ALU] |256| 
        OR        AL,#0x0300            ; [CPU_ALU] |256| 
        MOV       @$BLOCKED(_Flash0CtrlRegs),AL ; [CPU_ALU] |256| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_Flash0CtrlRegs+384 ; [CPU_ARAU] 
        OR        @$BLOCKED(_Flash0CtrlRegs)+384,#0x0002 ; [CPU_ALU] |269| 
...
;     | nts to enable ECC                                                      
;----------------------------------------------------------------------
        OR        @$BLOCKED(_Flash0CtrlRegs)+384,#0x0001 ; [CPU_ALU] |270| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_Flash0EccRegs),#0xfff0 ; [CPU_ALU] |274| 
        ORB       AL,#0x0a              ; [CPU_ALU] |274| 
        MOV       @$BLOCKED(_Flash0EccRegs),AL ; [CPU_ALU] |274| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_Flash0CtrlRegs+30 ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_Flash0CtrlRegs)+30,#0xff00 ; [CPU_ALU] |301| 
        ORB       AL,#0x14              ; [CPU_ALU] |301| 
        MOV       @$BLOCKED(_Flash0CtrlRegs)+30,AL ; [CPU_ALU] |301| 
...
; 305 | // power down pump                                                     
;----------------------------------------------------------------------
        AND       @$BLOCKED(_Flash0CtrlRegs)+32,#0xfffc ; [CPU_ALU] |304| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_Flash0CtrlRegs)+36,#0xfffe ; [CPU_ALU] |306| 
...
; 330 | #endif                                                                 
;----------------------------------------------------------------------
        MOV       AL,#2                 ; [CPU_ALU] |323| 
        MOV       AH,#23130             ; [CPU_ALU] |323| 
        MOVL      @_FlashPumpSemaphoreRegs,ACC ; [CPU_ALU] |323| 
$C$L3:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 321,column 10,is_stmt,isa 0
        ...
        MOV       AL,@_FlashPumpSemaphoreRegs ; [CPU_ALU] |321| 
        ANDB      AL,#0x03              ; [CPU_ALU] |321| 
        CMPB      AL,#2                 ; [CPU_ALU] |321| 
        B         $C$L2,NEQ             ; [CPU_ALU] |321| 
        ; branchcc occurs ; [] |321| 
...
;----------------------------------------------------------------------
        ...
        MOV       AH,#23130             ; [CPU_ALU] |342| 
        MOVW      DP,#_FlashPumpSemaphoreRegs ; [CPU_ARAU] 
        MOVL      @_FlashPumpSemaphoreRegs,ACC ; [CPU_ALU] |342| 
...
;----------------------------------------------------------------------
        ...
        AND       AL,@$BLOCKED(_WdRegs)+37,#0xff00 ; [CPU_ALU] |355| 
        ORB       AL,#0x55              ; [CPU_ALU] |355| 
        MOV       @$BLOCKED(_WdRegs)+37,AL ; [CPU_ALU] |355| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_WdRegs)+37,#0xff00 ; [CPU_ALU] |356| 
        ORB       AL,#0xaa              ; [CPU_ALU] |356| 
        MOV       @$BLOCKED(_WdRegs)+37,AL ; [CPU_ALU] |356| 
...
;----------------------------------------------------------------------
        ...
        MOV       AL,@$BLOCKED(_WdRegs)+41 ; [CPU_ALU] |370| 
        ANDB      AL,#0x07              ; [CPU_ALU] |370| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[1]            ; [CPU_ALU] |371| 
        ORB       AL,#0x68              ; [CPU_ALU] |371| 
        MOV       @$BLOCKED(_WdRegs)+41,AL ; [CPU_ALU] |371| 
...
$C$DW$45	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$45, DW_AT_location[DW_OP_breg20 -4]
        ...
        MOV       *-SP[4],AR5           ; [CPU_ALU] |384| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |384| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |384| 
...
;----------------------------------------------------------------------
        ...
        MOVZ      AR6,*-SP[1]           ; [CPU_ALU] |385| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+8 ; [CPU_ALU] |385| 
        ANDB      AL,#0x03              ; [CPU_ALU] |385| 
        MOVU      ACC,AL                ; [CPU_ALU] |385| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |385| 
        B         $C$L4,NEQ             ; [CPU_ALU] |385| 
        ; branchcc occurs ; [] |385| 
        MOVZ      AR6,*-SP[2]           ; [CPU_ALU] |385| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+20 ; [CPU_ALU] |385| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |385| 
        MOVU      ACC,AL                ; [CPU_ALU] |385| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |385| 
        B         $C$L4,NEQ             ; [CPU_ALU] |385| 
        ; branchcc occurs ; [] |385| 
        MOVZ      AR6,*-SP[3]           ; [CPU_ALU] |385| 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+20,#0x0300 ; [CPU_ALU] |385| 
        LSR       AL,8                  ; [CPU_ALU] |385| 
        MOVU      ACC,AL                ; [CPU_ALU] |385| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |385| 
        B         $C$L4,NEQ             ; [CPU_ALU] |385| 
        ; branchcc occurs ; [] |385| 
        MOVZ      AR6,*-SP[4]           ; [CPU_ALU] |385| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+34 ; [CPU_ALU] |385| 
        ANDB      AL,#0x3f              ; [CPU_ALU] |385| 
        MOVU      ACC,AL                ; [CPU_ALU] |385| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |385| 
        B         $C$L16,EQ             ; [CPU_ALU] |385| 
        ; branchcc occurs ; [] |385| 
...
$C$DW$46	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$46, DW_AT_TI_call
        ...
        LCR       #_SysIntOsc1Sel       ; [CPU_ALU] |399| 
...
$C$DW$47	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$47, DW_AT_TI_call
        ...
        LCR       #_SysIntOsc2Sel       ; [CPU_ALU] |403| 
...
$C$DW$48	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$48, DW_AT_TI_call
        ...
        LCR       #_SysXtalOscSel       ; [CPU_ALU] |407| 
...
; 408 | break;                                                                 
;----------------------------------------------------------------------
        B         $C$L9,UNC             ; [CPU_ALU] |408| 
        ; branch occurs ; [] |408| 
$C$L8:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 396,column 9,is_stmt,isa 0
        MOV       AL,*-SP[1]            ; [CPU_ALU] |396| 
        B         $C$L6,EQ              ; [CPU_ALU] |396| 
        ; branchcc occurs ; [] |396| 
        CMPB      AL,#1                 ; [CPU_ALU] |396| 
        B         $C$L7,EQ              ; [CPU_ALU] |396| 
        ; branchcc occurs ; [] |396| 
        CMPB      AL,#2                 ; [CPU_ALU] |396| 
        B         $C$L5,EQ              ; [CPU_ALU] |396| 
        ; branchcc occurs ; [] |396| 
$C$L9:    
...
;----------------------------------------------------------------------
        ...
        MOVZ      AR6,*-SP[2]           ; [CPU_ALU] |414| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+20 ; [CPU_ALU] |414| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |414| 
        MOVU      ACC,AL                ; [CPU_ALU] |414| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |414| 
        B         $C$L10,NEQ            ; [CPU_ALU] |414| 
        ; branchcc occurs ; [] |414| 
        MOVZ      AR6,*-SP[3]           ; [CPU_ALU] |414| 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+20,#0x0300 ; [CPU_ALU] |414| 
        LSR       AL,8                  ; [CPU_ALU] |414| 
        MOVU      ACC,AL                ; [CPU_ALU] |414| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |414| 
        B         $C$L13,EQ             ; [CPU_ALU] |414| 
        ; branchcc occurs ; [] |414| 
$C$L10:    
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+14,#0xfffd ; [CPU_ALU] |417| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+34,#0xffc0 ; [CPU_ALU] |418| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_ClkCfgRegs)+20 ; [CPU_ALU] |421| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |421| 
...
; 423 |                              ((fmult << 8U) | imult));                 
;----------------------------------------------------------------------
        AND       AL,#64640             ; [CPU_ALU] |422| 
        ANDB      AH,#0                 ; [CPU_ALU] |422| 
        MOVL      XAR7,ACC              ; [CPU_ALU] |422| 
        MOV       ACC,*-SP[3] << #8     ; [CPU_ALU] |422| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |422| 
        MOVZ      AR6,AL                ; [CPU_ALU] |422| 
        MOVL      ACC,XAR7              ; [CPU_ALU] |422| 
        OR        ACC,AR6               ; [CPU_ALU] |422| 
        MOVL      @$BLOCKED(_ClkCfgRegs)+20,ACC ; [CPU_ALU] |422| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_ClkCfgRegs)+14,#0x0001 ; [CPU_ALU] |425| 
...
;----------------------------------------------------------------------
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+22 ; [CPU_ALU] |428| 
        ANDB      AL,#0x01              ; [CPU_ALU] |428| 
        CMPB      AL,#1                 ; [CPU_ALU] |428| 
        B         $C$L11,NEQ            ; [CPU_ALU] |428| 
        ; branchcc occurs ; [] |428| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |436| 
        AND       AH,@$BLOCKED(_ClkCfgRegs)+20,#0xff80 ; [CPU_ALU] |436| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |436| 
        OR        AL,AH                 ; [CPU_ALU] |436| 
        MOV       @$BLOCKED(_ClkCfgRegs)+20,AL ; [CPU_ALU] |436| 
...
;     | ease                                                                   
;----------------------------------------------------------------------
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+22 ; [CPU_ALU] |439| 
        ANDB      AL,#0x01              ; [CPU_ALU] |439| 
        CMPB      AL,#1                 ; [CPU_ALU] |439| 
        B         $C$L12,NEQ            ; [CPU_ALU] |439| 
        ; branchcc occurs ; [] |439| 
	.dwendtag $C$DW$49
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |447| 
        CMPB      AL,#63                ; [CPU_ALU] |447| 
        B         $C$L14,EQ             ; [CPU_ALU] |447| 
        ; branchcc occurs ; [] |447| 
...
; 450 | }else                                                                  
;----------------------------------------------------------------------
        ADDB      AL,#1                 ; [CPU_ALU] |449| 
        AND       AH,@$BLOCKED(_ClkCfgRegs)+34,#0xffc0 ; [CPU_FPU] |449| 
        ANDB      AL,#0x3f              ; [CPU_ALU] |449| 
        OR        AL,AH                 ; [CPU_ALU] |449| 
        MOV       @$BLOCKED(_ClkCfgRegs)+34,AL ; [CPU_ALU] |449| 
        B         $C$L15,UNC            ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L14:    
...
;----------------------------------------------------------------------
        AND       AH,@$BLOCKED(_ClkCfgRegs)+34,#0xffc0 ; [CPU_ALU] |452| 
        ANDB      AL,#0x3f              ; [CPU_ALU] |452| 
        OR        AL,AH                 ; [CPU_ALU] |452| 
        MOV       @$BLOCKED(_ClkCfgRegs)+34,AL ; [CPU_ALU] |452| 
$C$L15:    
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_ClkCfgRegs)+14,#0x0002 ; [CPU_ALU] |456| 
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[4]            ; [CPU_ALU] |462| 
        AND       AH,@$BLOCKED(_ClkCfgRegs)+34,#0xffc0 ; [CPU_ALU] |462| 
        ANDB      AL,#0x3f              ; [CPU_ALU] |462| 
        OR        AL,AH                 ; [CPU_ALU] |462| 
        MOV       @$BLOCKED(_ClkCfgRegs)+34,AL ; [CPU_ALU] |462| 
...
;----------------------------------------------------------------------
        MOV       *-SP[4],AR5           ; [CPU_ALU] |476| 
        MOV       *-SP[3],AR4           ; [CPU_ALU] |476| 
        MOV       *-SP[2],AH            ; [CPU_ALU] |476| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |476| 
...
;----------------------------------------------------------------------
        ...
        MOVZ      AR6,*-SP[1]           ; [CPU_ALU] |479| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+10 ; [CPU_ALU] |479| 
        ANDB      AL,#0x03              ; [CPU_ALU] |479| 
        MOVU      ACC,AL                ; [CPU_ALU] |479| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |479| 
        B         $C$L20,NEQ            ; [CPU_ALU] |479| 
        ; branchcc occurs ; [] |479| 
        MOVZ      AR6,*-SP[2]           ; [CPU_ALU] |479| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+30 ; [CPU_ALU] |479| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |479| 
        MOVU      ACC,AL                ; [CPU_ALU] |479| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |479| 
        B         $C$L20,NEQ            ; [CPU_ALU] |479| 
        ; branchcc occurs ; [] |479| 
        MOVZ      AR6,*-SP[3]           ; [CPU_ALU] |479| 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+30,#0x0300 ; [CPU_ALU] |479| 
        LSR       AL,8                  ; [CPU_ALU] |479| 
        MOVU      ACC,AL                ; [CPU_ALU] |479| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |479| 
        B         $C$L20,NEQ            ; [CPU_ALU] |479| 
        ; branchcc occurs ; [] |479| 
        MOVZ      AR6,*-SP[4]           ; [CPU_ALU] |479| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+36 ; [CPU_ALU] |479| 
        ANDB      AL,#0x03              ; [CPU_ALU] |479| 
        MOVU      ACC,AL                ; [CPU_ALU] |479| 
        CMPL      ACC,XAR6              ; [CPU_ALU] |479| 
        B         $C$L28,EQ             ; [CPU_ALU] |479| 
        ; branchcc occurs ; [] |479| 
...
$C$DW$62	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$62, DW_AT_TI_call
        ...
        LCR       #_AuxIntOsc2Sel       ; [CPU_ALU] |492| 
...
$C$DW$63	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$63, DW_AT_TI_call
        ...
        LCR       #_AuxXtalOscSel       ; [CPU_ALU] |496| 
...
;     | er                                                                     
;----------------------------------------------------------------------
        B         $C$L21,UNC            ; [CPU_ALU] |501| 
        ; branch occurs ; [] |501| 
$C$L20:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 488,column 2,is_stmt,isa 0
        MOV       AL,*-SP[1]            ; [CPU_ALU] |488| 
        B         $C$L17,EQ             ; [CPU_ALU] |488| 
        ; branchcc occurs ; [] |488| 
        CMPB      AL,#1                 ; [CPU_ALU] |488| 
        B         $C$L18,EQ             ; [CPU_ALU] |488| 
        ; branchcc occurs ; [] |488| 
        CMPB      AL,#4                 ; [CPU_ALU] |488| 
        B         $C$L19,EQ             ; [CPU_ALU] |488| 
        ; branchcc occurs ; [] |488| 
$C$L21:    
...
;     | t.FMULT !=fmult)                                                       
;----------------------------------------------------------------------
        MOVU      ACC,*-SP[2]           ; [CPU_ALU] |506| 
        MOVW      DP,#_ClkCfgRegs+30    ; [CPU_ARAU] 
        MOVL      XAR6,ACC              ; [CPU_ALU] |506| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+30 ; [CPU_ALU] |506| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |506| 
        MOVZ      AR7,AL                ; [CPU_ALU] |506| 
        MOVL      ACC,XAR6              ; [CPU_ALU] |506| 
        CMPL      ACC,XAR7              ; [CPU_ALU] |506| 
        B         $C$L22,NEQ            ; [CPU_ALU] |506| 
        ; branchcc occurs ; [] |506| 
        MOVU      ACC,*-SP[3]           ; [CPU_ALU] |506| 
        MOVL      XAR6,ACC              ; [CPU_ALU] |506| 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+30,#0x0300 ; [CPU_ALU] |506| 
        LSR       AL,8                  ; [CPU_ALU] |506| 
        MOVZ      AR7,AL                ; [CPU_ALU] |506| 
        MOVL      ACC,XAR6              ; [CPU_ALU] |506| 
        CMPL      ACC,XAR7              ; [CPU_ALU] |506| 
        B         $C$L25,EQ             ; [CPU_ALU] |506| 
        ; branchcc occurs ; [] |506| 
$C$L22:    
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_ClkCfgRegs)+36,#0x0003 ; [CPU_ALU] |509| 
...
;----------------------------------------------------------------------
        MOVL      ACC,@$BLOCKED(_ClkCfgRegs)+30 ; [CPU_ALU] |512| 
        MOVL      *-SP[8],ACC           ; [CPU_ALU] |512| 
...
; 514 |                              ((fmult << 8U) | imult));                 
;----------------------------------------------------------------------
        AND       AL,#64640             ; [CPU_ALU] |513| 
        ANDB      AH,#0                 ; [CPU_ALU] |513| 
        MOVL      XAR7,ACC              ; [CPU_ALU] |513| 
        MOV       ACC,*-SP[3] << #8     ; [CPU_ALU] |513| 
        OR        AL,*-SP[2]            ; [CPU_ALU] |513| 
        MOVZ      AR6,AL                ; [CPU_ALU] |513| 
        MOVL      ACC,XAR7              ; [CPU_ALU] |513| 
        OR        ACC,AR6               ; [CPU_ALU] |513| 
        MOVL      @$BLOCKED(_ClkCfgRegs)+30,ACC ; [CPU_ALU] |513| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_ClkCfgRegs)+24,#0x0001 ; [CPU_ALU] |516| 
...
;----------------------------------------------------------------------
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+32 ; [CPU_ALU] |520| 
        ANDB      AL,#0x01              ; [CPU_ALU] |520| 
        CMPB      AL,#1                 ; [CPU_ALU] |520| 
        B         $C$L23,NEQ            ; [CPU_ALU] |520| 
        ; branchcc occurs ; [] |520| 
...
;     | iplier                                                                 
;----------------------------------------------------------------------
        MOV       AL,*-SP[2]            ; [CPU_ALU] |529| 
        AND       AH,@$BLOCKED(_ClkCfgRegs)+30,#0xff80 ; [CPU_ALU] |529| 
        ANDB      AL,#0x7f              ; [CPU_ALU] |529| 
        OR        AL,AH                 ; [CPU_ALU] |529| 
        MOV       @$BLOCKED(_ClkCfgRegs)+30,AL ; [CPU_ALU] |529| 
...
;     | s                                                                      
;----------------------------------------------------------------------
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+32 ; [CPU_ALU] |533| 
        ANDB      AL,#0x01              ; [CPU_ALU] |533| 
        CMPB      AL,#1                 ; [CPU_ALU] |533| 
        B         $C$L24,NEQ            ; [CPU_ALU] |533| 
        ; branchcc occurs ; [] |533| 
	.dwendtag $C$DW$65
...
;----------------------------------------------------------------------
        MOV       AL,*-SP[5]            ; [CPU_ALU] |545| 
        AND       AH,@$BLOCKED(_ClkCfgRegs)+36,#0xfffc ; [CPU_ALU] |545| 
        ADDB      AL,#-1                ; [CPU_ALU] |545| 
        ANDB      AL,#0x03              ; [CPU_ALU] |545| 
        OR        AL,AH                 ; [CPU_ALU] |545| 
        MOV       @$BLOCKED(_ClkCfgRegs)+36,AL ; [CPU_ALU] |545| 
...
;----------------------------------------------------------------------
        MOVU      ACC,*-SP[4]           ; [CPU_ALU] |549| 
        MOVL      XAR6,ACC              ; [CPU_ALU] |549| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+36 ; [CPU_ALU] |549| 
        ANDB      AL,#0x03              ; [CPU_ALU] |549| 
        MOVZ      AR7,AL                ; [CPU_ALU] |549| 
        MOVL      ACC,XAR6              ; [CPU_ALU] |549| 
        CMPL      ACC,XAR7              ; [CPU_ALU] |549| 
        B         $C$L27,EQ             ; [CPU_ALU] |549| 
        ; branchcc occurs ; [] |549| 
...
; 551 | DELAY_US(15L);                                                         
;----------------------------------------------------------------------
        MOVL      XAR4,#598             ; [CPU_ARAU] |551| 
        SPM       #0                    ; [CPU_ALU] 
        MOVL      ACC,XAR4              ; [CPU_ALU] |551| 
$C$DW$67	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$67, DW_AT_low_pc(0x00)
	.dwattr $C$DW$67, DW_AT_name("_F28x_usDelay")
	.dwattr $C$DW$67, DW_AT_TI_call

        LCR       #_F28x_usDelay        ; [CPU_ALU] |551| 
...
$C$L27:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 542,column 9,is_stmt,isa 0
        MOVU      ACC,*-SP[4]           ; [CPU_ALU] |542| 
        MOVW      DP,#_ClkCfgRegs+36    ; [CPU_ARAU] 
        MOVL      XAR6,ACC              ; [CPU_ALU] |542| 
        MOV       AL,@$BLOCKED(_ClkCfgRegs)+36 ; [CPU_ALU] |542| 
        ANDB      AL,#0x03              ; [CPU_ALU] |542| 
        MOVZ      AR7,AL                ; [CPU_ALU] |542| 
        MOVL      ACC,XAR6              ; [CPU_ALU] |542| 
        CMPL      ACC,XAR7              ; [CPU_ALU] |542| 
        B         $C$L26,NEQ            ; [CPU_ALU] |542| 
        ; branchcc occurs ; [] |542| 
...
;----------------------------------------------------------------------
        OR        @$BLOCKED(_ClkCfgRegs)+24,#0x0002 ; [CPU_ALU] |556| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |586| 
        MOVW      DP,#_DcsmZ1Regs+16    ; [CPU_ARAU] 
        SUBB      ACC,#1                ; [CPU_ALU] |586| 
        MOVL      @$BLOCKED(_DcsmZ1Regs)+16,ACC ; [CPU_ALU] |586| 
...
;----------------------------------------------------------------------
        ...
        SUBB      ACC,#1                ; [CPU_ALU] |587| 
        MOVL      @$BLOCKED(_DcsmZ1Regs)+18,ACC ; [CPU_ALU] |587| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |588| 
        SUBB      ACC,#1                ; [CPU_ALU] |588| 
        MOVL      @$BLOCKED(_DcsmZ1Regs)+20,ACC ; [CPU_ALU] |588| 
...
;----------------------------------------------------------------------
        ...
        MOVL      @$BLOCKED(_DcsmZ1Regs)+22,ACC ; [CPU_ALU] |589| 
...
;----------------------------------------------------------------------
        ...
        SUBB      ACC,#1                ; [CPU_ALU] |591| 
        MOVL      @$BLOCKED(_DcsmZ2Regs)+16,ACC ; [CPU_ALU] |591| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |592| 
        SUBB      ACC,#1                ; [CPU_ALU] |592| 
        MOVL      @$BLOCKED(_DcsmZ2Regs)+18,ACC ; [CPU_ALU] |592| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |593| 
        SUBB      ACC,#1                ; [CPU_ALU] |593| 
        MOVL      @$BLOCKED(_DcsmZ2Regs)+20,ACC ; [CPU_ALU] |593| 
...
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |594| 
        SUBB      ACC,#1                ; [CPU_ALU] |594| 
        MOVL      @$BLOCKED(_DcsmZ2Regs)+22,ACC ; [CPU_ALU] |594| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+8     ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+8,#0xfffc ; [CPU_ALU] |626| 
        ORB       AL,#0x02              ; [CPU_ALU] |626| 
        MOV       @$BLOCKED(_ClkCfgRegs)+8,AL ; [CPU_ALU] |626| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+8     ; [CPU_ARAU] 
        AND       @$BLOCKED(_ClkCfgRegs)+8,#0xfff7 ; [CPU_ALU] |642| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+8,#0xfffc ; [CPU_ALU] |643| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+8     ; [CPU_ARAU] 
        AND       @$BLOCKED(_ClkCfgRegs)+8,#0xffef ; [CPU_ALU] |658| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_ClkCfgRegs)+8,#0xfffc ; [CPU_ALU] |659| 
        ORB       AL,#0x01              ; [CPU_ALU] |659| 
        MOV       @$BLOCKED(_ClkCfgRegs)+8,AL ; [CPU_ALU] |659| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+8     ; [CPU_ARAU] 
        AND       @$BLOCKED(_ClkCfgRegs)+8,#0xfff7 ; [CPU_ALU] |676| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+10,#0xfffc ; [CPU_ALU] |677| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+8     ; [CPU_ARAU] 
        AND       @$BLOCKED(_ClkCfgRegs)+8,#0xffef ; [CPU_ALU] |692| 
...
;----------------------------------------------------------------------
        AND       AL,@$BLOCKED(_ClkCfgRegs)+10,#0xfffc ; [CPU_ALU] |693| 
        ORB       AL,#0x01              ; [CPU_ALU] |693| 
        MOV       @$BLOCKED(_ClkCfgRegs)+10,AL ; [CPU_ALU] |693| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+10    ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_ClkCfgRegs)+10,#0xfffc ; [CPU_ALU] |708| 
        ORB       AL,#0x02              ; [CPU_ALU] |708| 
        MOV       @$BLOCKED(_ClkCfgRegs)+10,AL ; [CPU_ALU] |708| 
...
;----------------------------------------------------------------------
        ...
        AND       @$BLOCKED(_CpuSysRegs)+118,#0xfffc ; [CPU_ALU] |718| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_CpuSysRegs+118   ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_CpuSysRegs)+118,#0xfffc ; [CPU_ALU] |727| 
        ORB       AL,#0x01              ; [CPU_ALU] |727| 
        MOV       @$BLOCKED(_CpuSysRegs)+118,AL ; [CPU_ALU] |727| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_CpuSysRegs+118   ; [CPU_ARAU] 
        AND       AL,@$BLOCKED(_CpuSysRegs)+118,#0xfffc ; [CPU_ALU] |739| 
        ORB       AL,#0x02              ; [CPU_ALU] |739| 
        MOV       @$BLOCKED(_CpuSysRegs)+118,AL ; [CPU_ALU] |739| 
...
$C$L29:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 741,column 10,is_stmt,isa 0
        ...
        MOV       AL,@$BLOCKED(_DevCfgRegs)+293 ; [CPU_ALU] |741| 
        ANDB      AL,#0x03              ; [CPU_ALU] |741| 
        CMPB      AL,#1                 ; [CPU_ALU] |741| 
        B         $C$L29,NEQ            ; [CPU_ALU] |741| 
        ; branchcc occurs ; [] |741| 
...
;----------------------------------------------------------------------
        ...
        AND       @$BLOCKED(_ClkCfgRegs)+14,#0xfffd ; [CPU_ALU] |743| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+14,#0xfffe ; [CPU_ALU] |744| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_CpuSysRegs+118   ; [CPU_ARAU] 
        OR        @$BLOCKED(_CpuSysRegs)+118,#0x0003 ; [CPU_ALU] |758| 
...
$C$L30:    
	.dwpsn	file "C:/ti/controlSUITE/device_support/F2837xD/v190/F2837xD_common/source/F2837xD_SysCtrl.c",line 760,column 10,is_stmt,isa 0
        MOVW      DP,#_DevCfgRegs+293   ; [CPU_ARAU] 
        MOV       AL,@$BLOCKED(_DevCfgRegs)+293 ; [CPU_ALU] |760| 
        ANDB      AL,#0x03              ; [CPU_ALU] |760| 
        B         $C$L31,NEQ            ; [CPU_ALU] |760| 
        ; branchcc occurs ; [] |760| 
        MOV       AL,@$BLOCKED(_DevCfgRegs)+292 ; [CPU_ALU] |760| 
        ANDB      AL,#0x01              ; [CPU_ALU] |760| 
        CMPB      AL,#1                 ; [CPU_ALU] |760| 
        B         $C$L30,EQ             ; [CPU_ALU] |760| 
        ; branchcc occurs ; [] |760| 
$C$L31:    
...
$C$DW$90	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$90, DW_AT_TI_call
        ...
        LCR       #_DisablePeripheralClocks ; [CPU_ALU] |761| 
...
;----------------------------------------------------------------------
        MOVW      DP,#_ClkCfgRegs+14    ; [CPU_ARAU] 
        AND       @$BLOCKED(_ClkCfgRegs)+14,#0xfffd ; [CPU_ALU] |763| 
...
;----------------------------------------------------------------------
        AND       @$BLOCKED(_ClkCfgRegs)+14,#0xfffe ; [CPU_ALU] |764| 
