...
;* Date/Time created: Thu Feb 29 14:44:48 2024                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
...
;	C:\ti\ccs1010\ccs\tools\compiler\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\Admin\\AppData\\Local\\Temp\\{F8E0D88E-B6E9-4FEF-A71D-318F85EB4D3A} 
	.sect	".text:retain"
	.retain
	.retainrefs
	.global	_TINT0_isr
...
$C$DW$12	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$12, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$12, DW_AT_TI_begin_line(0x0e)
	.dwattr $C$DW$12, DW_AT_TI_begin_column(0x10)
	.dwattr $C$DW$12, DW_AT_TI_interrupt
	.dwattr $C$DW$12, DW_AT_TI_max_frame_size(-28)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 15,column 1,is_stmt,address _TINT0_isr,isa 0

	.dwfde $C$DW$CIE, _TINT0_isr
;----------------------------------------------------------------------
;  14 | interrupt void TINT0_isr(void)                                         
;  16 | #ifdef PIEMASK0                                                        
;----------------------------------------------------------------------
...
$C$DW$13	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 17,column 50,is_stmt,isa 0
;----------------------------------------------------------------------
;  17 | volatile unsigned int PIEIER1_stack_save = PieCtrlRegs.PIEIER1.all;    
;  18 | #endif                                                                 
;  19 | #ifdef PIEMASK1                                                        
;  20 | volatile unsigned int PIEIER2_stack_save  = PieCtrlRegs.PIEIER2.all;   
;  21 | #endif                                                                 
;  22 | #ifdef PIEMASK2                                                        
;  23 | volatile unsigned int PIEIER3_stack_save  = PieCtrlRegs.PIEIER3.all;   
;  24 | #endif                                                                 
;  25 | #ifdef PIEMASK3                                                        
;  26 | volatile unsigned int PIEIER4_stack_save  = PieCtrlRegs.PIEIER4.all;   
;  27 | #endif                                                                 
;  28 | #ifdef PIEMASK4                                                        
;  29 | volatile unsigned int PIEIER5_stack_save  = PieCtrlRegs.PIEIER5.all;   
;  30 | #endif                                                                 
;  31 | #ifdef PIEMASK5                                                        
;  32 | volatile unsigned int PIEIER6_stack_save  = PieCtrlRegs.PIEIER6.all;   
;  33 | #endif                                                                 
;  34 | #ifdef PIEMASK6                                                        
;  35 | volatile unsigned int PIEIER7_stack_save  = PieCtrlRegs.PIEIER7.all;   
;  36 | #endif                                                                 
;  37 | #ifdef PIEMASK7                                                        
;  38 | volatile unsigned int PIEIER8_stack_save  = PieCtrlRegs.PIEIER8.all;   
;  39 | #endif                                                                 
;  40 | #ifdef PIEMASK8                                                        
;  41 | volatile unsigned int PIEIER9_stack_save  = PieCtrlRegs.PIEIER9.all;   
;  42 | #endif                                                                 
;  43 | #ifdef PIEMASK9                                                        
;  44 | volatile unsigned int PIEIER10_stack_save = PieCtrlRegs.PIEIER10.all;  
;  45 | #endif                                                                 
;  46 | #ifdef PIEMASK10                                                       
;  47 | volatile unsigned int PIEIER11_stack_save = PieCtrlRegs.PIEIER11.all;  
;  48 | #endif                                                                 
;  49 | #ifdef PIEMASK11                                                       
;  50 | volatile unsigned int PIEIER12_stack_save = PieCtrlRegs.PIEIER12.all;  
;  51 | #endif                                                                 
;  53 | #ifdef PIEMASK0                                                        
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+2    ; [CPU_ARAU] 
        MOV       AL,@$BLOCKED(_PieCtrlRegs)+2 ; [CPU_ALU] |17| 
        MOV       *-SP[1],AL            ; [CPU_ALU] |17| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 54,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
;  54 | PieCtrlRegs.PIEIER1.all &= ~PIEMASK0;      /* disable group1 lower/equa
;     | l priority interrupts */                                               
;  55 | #endif                                                                 
;  56 | #ifdef PIEMASK1                                                        
;  57 | PieCtrlRegs.PIEIER2.all &= ~PIEMASK1;      /* disable group2 lower/equa
;     | l priority interrupts */                                               
;  58 | #endif                                                                 
;  59 | #ifdef PIEMASK2                                                        
;  60 | PieCtrlRegs.PIEIER3.all &= ~PIEMASK2;      /* disable group3 lower/equa
;     | l priority interrupts */                                               
;  61 | #endif                                                                 
;  62 | #ifdef PIEMASK3                                                        
;  63 | PieCtrlRegs.PIEIER4.all &= ~PIEMASK3;      /* disable group4 lower/equa
;     | l priority interrupts */                                               
;  64 | #endif                                                                 
;  65 | #ifdef PIEMASK4                                                        
;  66 | PieCtrlRegs.PIEIER5.all &= ~PIEMASK4;      /* disable group5 lower/equa
;     | l priority interrupts */                                               
;  67 | #endif                                                                 
;  68 | #ifdef PIEMASK5                                                        
;  69 | PieCtrlRegs.PIEIER6.all &= ~PIEMASK5;      /* disable group6 lower/equa
;     | l priority interrupts */                                               
;  70 | #endif                                                                 
;  71 | #ifdef PIEMASK6                                                        
;  72 | PieCtrlRegs.PIEIER7.all &= ~PIEMASK6;      /* disable group7 lower/equa
;     | l priority interrupts */                                               
;  73 | #endif                                                                 
;  74 | #ifdef PIEMASK7                                                        
;  75 | PieCtrlRegs.PIEIER8.all &= ~PIEMASK7;      /* disable group8 lower/equa
;     | l priority interrupts */                                               
;  76 | #endif                                                                 
;  77 | #ifdef PIEMASK8                                                        
;  78 | PieCtrlRegs.PIEIER9.all &= ~PIEMASK8;      /* disable group9 lower/equa
;     | l priority interrupts */                                               
;  79 | #endif                                                                 
;  80 | #ifdef PIEMASK9                                                        
;  81 | PieCtrlRegs.PIEIER10.all &= ~PIEMASK9;     /* disable group10 lower/equ
;     | al priority interrupts */                                              
;  82 | #endif                                                                 
;  83 | #ifdef PIEMASK10                                                       
;  84 | PieCtrlRegs.PIEIER11.all &= ~PIEMASK10;    /* disable group11 lower/equ
;     | al priority interrupts */                                              
;  85 | #endif                                                                 
;  86 | #ifdef PIEMASK11                                                       
;  87 | PieCtrlRegs.PIEIER12.all &= ~PIEMASK11;    /* disable group12 lower/equ
;     | al priority interrupts */                                              
;  88 | #endif                                                                 
;  89 |   #ifdef PIEMASK12                                                     
;  90 |         IER &= ~(M_INT13);                                             
...
;  94 | #endif                                                                 
;----------------------------------------------------------------------
        AND       @$BLOCKED(_PieCtrlRegs)+2,#0xffbf ; [CPU_ALU] |54| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 96,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
;  96 | asm(" RPT #5 || NOP");               /* wait 5 cycles */               
;----------------------------------------------------------------------
 RPT #5 || NOP
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 97,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
;  97 | IFR &= ~IFRMASK;                           /* eventually disable lower/
;     | equal priority pending interrupts */                                   
;----------------------------------------------------------------------
        AND       IFR,#0xfffe           ; [CPU_ALU] |97| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 98,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
;  98 | PieCtrlRegs.PIEACK.all = IFRMASK;          /* ACK to allow other interr
;     | upts from the same group to fire */                                    
;----------------------------------------------------------------------
        MOVB      @$BLOCKED(_PieCtrlRegs)+1,#1,UNC ; [CPU_ALU] |98| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 99,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
;  99 | IER |= 1;                                                              
;----------------------------------------------------------------------
        OR        IER,#0x0001           ; [CPU_ALU] |99| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 100,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
; 100 | EINT;                                /* global interrupt enable */     
;----------------------------------------------------------------------
 clrc INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 101,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
; 101 | rt_OneStep();                                                          
;----------------------------------------------------------------------
        SPM       #0                    ; [CPU_ALU] 
$C$DW$14	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$14, DW_AT_TI_call
        ...
        LCR       #_rt_OneStep          ; [CPU_ALU] |101| 
        ; call occurs [#_rt_OneStep] ; [] |101| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 102,column 7,is_stmt,isa 0
;----------------------------------------------------------------------
; 102 | DINT;                                /* disable global interrupts durin
;     | g context switch, CPU will enable global interrupts after exiting ISR *
;     | /                                                                      
; 103 | #ifdef PIEMASK0                                                        
;----------------------------------------------------------------------
 setc INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 104,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 104 | PieCtrlRegs.PIEIER1.all = PIEIER1_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 105 | #endif                                                                 
; 106 | #ifdef PIEMASK1                                                        
; 107 | PieCtrlRegs.PIEIER2.all = PIEIER2_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 108 | #endif                                                                 
; 109 | #ifdef PIEMASK2                                                        
; 110 | PieCtrlRegs.PIEIER3.all = PIEIER3_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 111 | #endif                                                                 
; 112 | #ifdef PIEMASK3                                                        
; 113 | PieCtrlRegs.PIEIER4.all = PIEIER4_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 114 | #endif                                                                 
; 115 | #ifdef PIEMASK4                                                        
; 116 | PieCtrlRegs.PIEIER5.all = PIEIER5_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 117 | #endif                                                                 
; 118 | #ifdef PIEMASK5                                                        
; 119 | PieCtrlRegs.PIEIER6.all = PIEIER6_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 120 | #endif                                                                 
; 121 | #ifdef PIEMASK6                                                        
; 122 | PieCtrlRegs.PIEIER7.all = PIEIER7_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 123 | #endif                                                                 
; 124 | #ifdef PIEMASK7                                                        
; 125 | PieCtrlRegs.PIEIER8.all = PIEIER8_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 126 | #endif                                                                 
; 127 | #ifdef PIEMASK8                                                        
; 128 | PieCtrlRegs.PIEIER9.all = PIEIER9_stack_save;/*restore PIEIER register
;     | that was modified */                                                   
; 129 | #endif                                                                 
; 130 | #ifdef PIEMASK9                                                        
; 131 | PieCtrlRegs.PIEIER10.all= PIEIER10_stack_save;/*restore PIEIER register
;     |  that was modified */                                                  
; 132 | #endif                                                                 
; 133 | #ifdef PIEMASK10                                                       
; 134 | PieCtrlRegs.PIEIER11.all= PIEIER11_stack_save;/*restore PIEIER register
;     |  that was modified */                                                  
; 135 | #endif                                                                 
; 136 | #ifdef PIEMASK11                                                       
; 137 | PieCtrlRegs.PIEIER12.all= PIEIER12_stack_save;/*restore PIEIER register
;     |  that was modified */                                                  
; 138 | #endif                                                                 
; 139 |   #ifdef PIEMASK12                                                     
; 140 |         IER |= M_INT13;                                                
...
;----------------------------------------------------------------------
        ...
        MOVW      DP,#_PieCtrlRegs+2    ; [CPU_ARAU] 
        MOV       @$BLOCKED(_PieCtrlRegs)+2,AL ; [CPU_ALU] |104| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 145,column 1,is_stmt,isa 0
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -26
...
$C$DW$15	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$15, DW_AT_TI_return
        ...
        IRET      ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$12, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$12, DW_AT_TI_end_line(0x91)
...
$C$DW$16	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$16, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$16, DW_AT_TI_begin_line(0x93)
	.dwattr $C$DW$16, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$16, DW_AT_TI_max_frame_size(-8)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 148,column 1,is_stmt,address _configureTimer0,isa 0
...
;----------------------------------------------------------------------
; 147 | void configureTimer0(float baseRate, float systemClock)                
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; 149 | #ifndef TIC2000_SOC_BASEPRODUCT                                        
; 150 |   #ifdef CPU1                                                          
;----------------------------------------------------------------------
        MOV32     *-SP[4],R1H           ; [CPU_FPU] |148| 
        MOV32     *-SP[2],R0H           ; [CPU_FPU] |148| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 151,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 151 | EINT;                                                                  
;----------------------------------------------------------------------
 clrc INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 152,column 30,is_stmt,isa 0
;----------------------------------------------------------------------
; 152 | uint32_t ipcCountVar = 0;                                              
;----------------------------------------------------------------------
        MOVB      ACC,#0                ; [CPU_ALU] |152| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |152| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 153,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 153 | if (0x425 == mwInitStart)                                              
;----------------------------------------------------------------------
        MOVL      XAR4,#1061            ; [CPU_ARAU] |153| 
        MOVW      DP,#_mwInitStart      ; [CPU_ARAU] 
        MOVL      ACC,XAR4              ; [CPU_ALU] |153| 
        CMPL      ACC,@_mwInitStart     ; [CPU_ALU] |153| 
        B         $C$L2,NEQ             ; [CPU_ALU] |153| 
        ; branchcc occurs ; [] |153| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 156,column 21,is_stmt,isa 0
;----------------------------------------------------------------------
; 156 | while ((0x36E != mwInitEnd))                                           
;----------------------------------------------------------------------
        MOVL      XAR4,#878             ; [CPU_ARAU] |156| 
        MOVW      DP,#_mwInitEnd        ; [CPU_ARAU] 
        MOVL      ACC,XAR4              ; [CPU_ALU] |156| 
        CMPL      ACC,@_mwInitEnd       ; [CPU_ALU] |156| 
        B         $C$L2,EQ              ; [CPU_ALU] |156| 
        ; branchcc occurs ; [] |156| 
$C$L1:    
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 158,column 17,is_stmt,isa 0
;----------------------------------------------------------------------
; 158 | ipcCountVar++;                                                         
;----------------------------------------------------------------------
        MOVB      ACC,#1                ; [CPU_ALU] |158| 
        ADDL      ACC,*-SP[6]           ; [CPU_ALU] |158| 
        MOVL      *-SP[6],ACC           ; [CPU_ALU] |158| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 156,column 21,is_stmt,isa 0
        MOVL      ACC,XAR4              ; [CPU_ALU] |156| 
        CMPL      ACC,@_mwInitEnd       ; [CPU_ALU] |156| 
        B         $C$L1,NEQ             ; [CPU_ALU] |156| 
        ; branchcc occurs ; [] |156| 
$C$L2:    
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 161,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 161 | DINT;                                                                  
; 162 | #else                                                                  
; 163 |       uint32_t *pulMsgRam;                                             
; 164 |       pulMsgRam = (void *)CPU01_TO_CPU02_PASSMSG;                      
; 165 | IPCLiteLtoRDataWrite(IPC_FLAG0, pulMsgRam[2], 0x36E,                   
; 166 |                  IPC_LENGTH_32_BITS, IPC_FLAG31);                      
; 167 | #endif                                                                 
; 168 | #endif                                                                 
;----------------------------------------------------------------------
 setc INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 176,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 176 | ConfigCpuTimer(&CpuTimer0, systemClock, baseRate * 1000000);           
;----------------------------------------------------------------------
        MOVIZ     R0H,#18804            ; [CPU_FPU] |176| 
        MOV32     R1H,*-SP[2]           ; [CPU_FPU] |176| 
        MOVL      XAR4,#_CpuTimer0      ; [CPU_ARAU] |176| 
        SPM       #0                    ; [CPU_ALU] 
        MOVXI     R0H,#9216             ; [CPU_FPU] |176| 

        MOV32     R0H,*-SP[4]           ; [CPU_FPU] |176| 
||      MPYF32    R1H,R0H,R1H           ; [CPU_FPU] |176| 
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_TI_call
        ...
        LCR       #_ConfigCpuTimer      ; [CPU_ALU] |176| 
        ; call occurs [#_ConfigCpuTimer] ; [] |176| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 177,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 177 | StartCpuTimer0();                                                      
; 179 | #ifdef TIC2000_SOC_BASEPRODUCT                                         
; 180 | PieCtrlRegs.PIEIFR1.bit.INTx7 = 1;   /* Set Pending interrupt for TINT0
;     | . TINT0 will trigger as soon as the its interrupt is enabled*/         
; 181 | #endif                                                                 
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer0Regs+4  ; [CPU_ARAU] 
        AND       @$BLOCKED(_CpuTimer0Regs)+4,#0xffef ; [CPU_ALU] |177| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 183,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 183 | EALLOW;                                                                
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 184,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 184 | PieVectTable.TIMER0_INT = &TINT0_isr;     /* Hook interrupt to the ISR*
;     | /                                                                      
;----------------------------------------------------------------------
        MOVW      DP,#_PieVectTable+76  ; [CPU_ARAU] 
        MOVL      XAR4,#_TINT0_isr      ; [CPU_ARAU] |184| 
        MOVL      @$BLOCKED(_PieVectTable)+76,XAR4 ; [CPU_ALU] |184| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 185,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 185 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 187,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 187 | PieCtrlRegs.PIEIER1.bit.INTx7 = 1;   /* Enable interrupt TINT0 */      
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+2    ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+2,#0x0040 ; [CPU_ALU] |187| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 188,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 188 | IER |= M_INT1;                                                         
;----------------------------------------------------------------------
        OR        IER,#0x0001           ; [CPU_ALU] |188| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 189,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_ALU] 
        SUBB      SP,#6                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$23, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$16, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$16, DW_AT_TI_end_line(0xbd)
...
$C$DW$24	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$24, DW_AT_name("stopTimer0")
	.dwattr $C$DW$24, DW_AT_low_pc(_stopTimer0)
	.dwattr $C$DW$24, DW_AT_high_pc(0x00)
	.dwattr $C$DW$24, DW_AT_TI_symbol_name("_stopTimer0")
	.dwattr $C$DW$24, DW_AT_external
	.dwattr $C$DW$24, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$24, DW_AT_TI_begin_line(0xbf)
	.dwattr $C$DW$24, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$24, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 192,column 1,is_stmt,address _stopTimer0,isa 0

	.dwfde $C$DW$CIE, _stopTimer0
;----------------------------------------------------------------------
; 191 | void stopTimer0(void)                                                  
;----------------------------------------------------------------------
...
_stopTimer0:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 193,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 193 | StopCpuTimer0();                                                       
;----------------------------------------------------------------------
        MOVW      DP,#_CpuTimer0Regs+4  ; [CPU_ARAU] 
        OR        @$BLOCKED(_CpuTimer0Regs)+4,#0x0010 ; [CPU_ALU] |193| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 194,column 1,is_stmt,isa 0
$C$DW$25	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$25, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$24, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$24, DW_AT_TI_end_line(0xc2)
...
$C$DW$26	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$26, DW_AT_name("enableTimer0Interrupt")
	.dwattr $C$DW$26, DW_AT_low_pc(_enableTimer0Interrupt)
	.dwattr $C$DW$26, DW_AT_high_pc(0x00)
	.dwattr $C$DW$26, DW_AT_TI_symbol_name("_enableTimer0Interrupt")
	.dwattr $C$DW$26, DW_AT_external
	.dwattr $C$DW$26, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$26, DW_AT_TI_begin_line(0xc3)
	.dwattr $C$DW$26, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$26, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 196,column 1,is_stmt,address _enableTimer0Interrupt,isa 0

	.dwfde $C$DW$CIE, _enableTimer0Interrupt
;----------------------------------------------------------------------
; 195 | void enableTimer0Interrupt(void)                                       
;----------------------------------------------------------------------
...
_enableTimer0Interrupt:
	.dwcfi	cfa_offset, -2
	.dwcfi	save_reg_to_mem, 26, 0
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 197,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 197 | asm(" SETC INTM"); /* Disable Interrupt Global Enable Bit - set it to 1
;     |  */                                                                    
;----------------------------------------------------------------------
 SETC INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 198,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 198 | EALLOW;                                                                
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 199,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 199 | PieCtrlRegs.PIEIER1.all |= (1 << 6); /* Enable PIER bit for timer 0 */ 
;----------------------------------------------------------------------
        MOVW      DP,#_PieCtrlRegs+2    ; [CPU_ARAU] 
        OR        @$BLOCKED(_PieCtrlRegs)+2,#0x0040 ; [CPU_ALU] |199| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 200,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 200 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 201,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 201 | asm(" CLRC INTM"); /* Enable Interrupt Global Enable Bit - set it to 0
;     | */                                                                     
;----------------------------------------------------------------------
 CLRC INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 202,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_ALU] 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$27, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$26, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$26, DW_AT_TI_end_line(0xca)
...
$C$DW$28	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$28, DW_AT_name("disableTimer0Interrupt")
	.dwattr $C$DW$28, DW_AT_low_pc(_disableTimer0Interrupt)
	.dwattr $C$DW$28, DW_AT_high_pc(0x00)
	.dwattr $C$DW$28, DW_AT_TI_symbol_name("_disableTimer0Interrupt")
	.dwattr $C$DW$28, DW_AT_external
	.dwattr $C$DW$28, DW_AT_type(*$C$DW$T$104)
	.dwattr $C$DW$28, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$28, DW_AT_TI_begin_line(0xcc)
	.dwattr $C$DW$28, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$28, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 205,column 1,is_stmt,address _disableTimer0Interrupt,isa 0

	.dwfde $C$DW$CIE, _disableTimer0Interrupt
;----------------------------------------------------------------------
; 204 | bool disableTimer0Interrupt(void)                                      
;----------------------------------------------------------------------
...
$C$DW$29	.dwtag  DW_TAG_variable
	.dwattr $C$DW$29, DW_AT_name("isrEnabled")
	.dwattr $C$DW$29, DW_AT_TI_symbol_name("_isrEnabled")
	.dwattr $C$DW$29, DW_AT_type(*$C$DW$T$104)
	.dwattr $C$DW$29, DW_AT_location[DW_OP_breg20 -1]

	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 206,column 21,is_stmt,isa 0
;----------------------------------------------------------------------
; 206 | bool isrEnabled = false;                                               
;----------------------------------------------------------------------
        MOV       *-SP[1],#0            ; [CPU_ALU] |206| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 208,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 208 | asm(" SETC INTM"); /* Disable Interrupt Global Enable Bit - set it to 1
;     |  */                                                                    
;----------------------------------------------------------------------
 SETC INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 210,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 210 | isrEnabled = PieCtrlRegs.PIEIER1.all & (1 << 6) ;                      
;----------------------------------------------------------------------
        MOVB      AL,#0                 ; [CPU_ALU] |210| 
        MOVW      DP,#_PieCtrlRegs+2    ; [CPU_ARAU] 
        TBIT      @$BLOCKED(_PieCtrlRegs)+2,#6 ; [CPU_ALU] |210| 
        B         $C$L3,NTC             ; [CPU_ALU] |210| 
        ; branchcc occurs ; [] |210| 
        MOVB      AL,#1                 ; [CPU_ALU] |210| 
$C$L3:    
        MOV       *-SP[1],AL            ; [CPU_ALU] |210| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 211,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 211 | EALLOW;                                                                
;----------------------------------------------------------------------
 EALLOW
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 212,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 212 | PieCtrlRegs.PIEIER1.all &= ~(1 << 6); /* Disable PIER bit for timer 0 *
;     | /                                                                      
;----------------------------------------------------------------------
        AND       @$BLOCKED(_PieCtrlRegs)+2,#0xffbf ; [CPU_ALU] |212| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 213,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 213 | asm(" RPT #5 || NOP");                                                 
;----------------------------------------------------------------------
 RPT #5 || NOP
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 214,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 214 | IFR &= 0xFFFE;                                                         
;----------------------------------------------------------------------
        AND       IFR,#0xfffe           ; [CPU_ALU] |214| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 215,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 215 | PieCtrlRegs.PIEACK.all = 0x1;                                          
;----------------------------------------------------------------------
        MOVB      @$BLOCKED(_PieCtrlRegs)+1,#1,UNC ; [CPU_ALU] |215| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 216,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 216 | EDIS;                                                                  
;----------------------------------------------------------------------
 EDIS
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 217,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
; 217 | asm(" CLRC INTM"); /* Enable Interrupt Global Enable Bit - set it to 0
;     | */                                                                     
;----------------------------------------------------------------------
 CLRC INTM
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 219,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 219 | return isrEnabled;                                                     
;----------------------------------------------------------------------
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 220,column 1,is_stmt,isa 0
        SPM       #0                    ; [CPU_ALU] 
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$30, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$28, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$28, DW_AT_TI_end_line(0xdc)
...
$C$DW$31	.dwtag  DW_TAG_subprogram
	.dwattr $C$DW$31, DW_AT_name("restoreTimer0Interrupt")
	.dwattr $C$DW$31, DW_AT_low_pc(_restoreTimer0Interrupt)
	.dwattr $C$DW$31, DW_AT_high_pc(0x00)
	.dwattr $C$DW$31, DW_AT_TI_symbol_name("_restoreTimer0Interrupt")
	.dwattr $C$DW$31, DW_AT_external
	.dwattr $C$DW$31, DW_AT_TI_begin_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$31, DW_AT_TI_begin_line(0xde)
	.dwattr $C$DW$31, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$31, DW_AT_TI_max_frame_size(-4)
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 222,column 44,is_stmt,address _restoreTimer0Interrupt,isa 0

	.dwfde $C$DW$CIE, _restoreTimer0Interrupt
$C$DW$32	.dwtag  DW_TAG_formal_parameter
	.dwattr $C$DW$32, DW_AT_name("isrStatus")
	.dwattr $C$DW$32, DW_AT_TI_symbol_name("_isrStatus")
...
;----------------------------------------------------------------------
; 222 | void restoreTimer0Interrupt(bool isrStatus){                           
;----------------------------------------------------------------------
        MOV       *-SP[1],AL            ; [CPU_ALU] |222| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 223,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 223 | if(isrStatus)                                                          
;----------------------------------------------------------------------
        ...
        ; branchcc occurs ; [] |223| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 224,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 224 | enableTimer0Interrupt();                                               
; 225 | else                                                                   
;----------------------------------------------------------------------
$C$DW$34	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$34, DW_AT_TI_call
        ...
        LCR       #_enableTimer0Interrupt ; [CPU_ALU] |224| 
        ; call occurs [#_enableTimer0Interrupt] ; [] |224| 
        B         $C$L5,UNC             ; [CPU_ALU] 
        ; branch occurs ; [] 
$C$L4:    
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 226,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 226 | disableTimer0Interrupt();                                              
;----------------------------------------------------------------------
$C$DW$35	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$35, DW_AT_low_pc(0x00)
	.dwattr $C$DW$35, DW_AT_name("_disableTimer0Interrupt")
	.dwattr $C$DW$35, DW_AT_TI_call

        LCR       #_disableTimer0Interrupt ; [CPU_ALU] |226| 
        ; call occurs [#_disableTimer0Interrupt] ; [] |226| 
	.dwpsn	file "C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c",line 227,column 1,is_stmt,isa 0
$C$L5:    
        SUBB      SP,#2                 ; [CPU_ARAU] 
	.dwcfi	cfa_offset, -2
$C$DW$36	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$36, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$31, DW_AT_TI_end_file("C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/shared/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c")
	.dwattr $C$DW$31, DW_AT_TI_end_line(0xe3)
...
$C$DW$37	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$37, DW_AT_name("TIM")
	.dwattr $C$DW$37, DW_AT_TI_symbol_name("_TIM")
	.dwattr $C$DW$37, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$37, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$38	.dwtag  DW_TAG_member
	.dwattr $C$DW$38, DW_AT_type(*$C$DW$T$83)
	.dwattr $C$DW$38, DW_AT_name("PRD")
	.dwattr $C$DW$38, DW_AT_TI_symbol_name("_PRD")
	.dwattr $C$DW$38, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr $C$DW$38, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$39	.dwtag  DW_TAG_member
	.dwattr $C$DW$39, DW_AT_type(*$C$DW$T$85)
	.dwattr $C$DW$39, DW_AT_name("TCR")
	.dwattr $C$DW$39, DW_AT_TI_symbol_name("_TCR")
...
$C$DW$40	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$40, DW_AT_data_member_location[DW_OP_plus_uconst 0x5]
	.dwattr $C$DW$40, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$41	.dwtag  DW_TAG_member
	.dwattr $C$DW$41, DW_AT_type(*$C$DW$T$91)
	.dwattr $C$DW$41, DW_AT_name("TPR")
	.dwattr $C$DW$41, DW_AT_TI_symbol_name("_TPR")
	.dwattr $C$DW$41, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr $C$DW$41, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$42	.dwtag  DW_TAG_member
	.dwattr $C$DW$42, DW_AT_type(*$C$DW$T$89)
	.dwattr $C$DW$42, DW_AT_name("TPRH")
	.dwattr $C$DW$42, DW_AT_TI_symbol_name("_TPRH")
	.dwattr $C$DW$42, DW_AT_data_member_location[DW_OP_plus_uconst 0x7]
...
$C$DW$T$21	.dwtag  DW_TAG_volatile_type
	.dwattr $C$DW$T$21, DW_AT_type(*$C$DW$43)
...
$C$DW$44	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$44, DW_AT_name("RegsAddr")
	.dwattr $C$DW$44, DW_AT_TI_symbol_name("_RegsAddr")
	.dwattr $C$DW$44, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$44, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$45	.dwtag  DW_TAG_member
	.dwattr $C$DW$45, DW_AT_type(*$C$DW$T$23)
	.dwattr $C$DW$45, DW_AT_name("InterruptCount")
	.dwattr $C$DW$45, DW_AT_TI_symbol_name("_InterruptCount")
	.dwattr $C$DW$45, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr $C$DW$45, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$46	.dwtag  DW_TAG_member
	.dwattr $C$DW$46, DW_AT_type(*$C$DW$T$16)
	.dwattr $C$DW$46, DW_AT_name("CPUFreqInMHz")
	.dwattr $C$DW$46, DW_AT_TI_symbol_name("_CPUFreqInMHz")
	.dwattr $C$DW$46, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr $C$DW$46, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$47	.dwtag  DW_TAG_member
	.dwattr $C$DW$47, DW_AT_type(*$C$DW$T$16)
	.dwattr $C$DW$47, DW_AT_name("PeriodInUSec")
	.dwattr $C$DW$47, DW_AT_TI_symbol_name("_PeriodInUSec")
...
$C$DW$408	.dwtag  DW_TAG_member
	.dwattr $C$DW$408, DW_AT_type(*$C$DW$T$65)
...
$C$DW$502	.dwtag  DW_TAG_member
	.dwattr $C$DW$502, DW_AT_type(*$C$DW$T$60)
...
$C$DW$504	.dwtag  DW_TAG_member
	.dwattr $C$DW$504, DW_AT_type(*$C$DW$T$62)
...
$C$DW$508	.dwtag  DW_TAG_member
	.dwattr $C$DW$508, DW_AT_type(*$C$DW$T$66)
...
$C$DW$514	.dwtag  DW_TAG_member
	.dwattr $C$DW$514, DW_AT_type(*$C$DW$T$72)
...
$C$DW$518	.dwtag  DW_TAG_member
	.dwattr $C$DW$518, DW_AT_type(*$C$DW$T$76)
...
$C$DW$520	.dwtag  DW_TAG_member
	.dwattr $C$DW$520, DW_AT_type(*$C$DW$T$54)
...
$C$DW$524	.dwtag  DW_TAG_member
	.dwattr $C$DW$524, DW_AT_type(*$C$DW$T$58)
...
$C$DW$525	.dwtag  DW_TAG_TI_far_type
	.dwattr $C$DW$525, DW_AT_type(*$C$DW$T$77)

$C$DW$T$96	.dwtag  DW_TAG_volatile_type
	.dwattr $C$DW$T$96, DW_AT_type(*$C$DW$525)
...
$C$DW$750	.dwtag  DW_TAG_TI_far_type
	.dwattr $C$DW$750, DW_AT_type(*$C$DW$T$81)

$C$DW$T$97	.dwtag  DW_TAG_volatile_type
	.dwattr $C$DW$T$97, DW_AT_type(*$C$DW$750)
...
$C$DW$751	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$751, DW_AT_name("LSW")
	.dwattr $C$DW$751, DW_AT_TI_symbol_name("_LSW")
...
$C$DW$752	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$752, DW_AT_name("MSW")
	.dwattr $C$DW$752, DW_AT_TI_symbol_name("_MSW")
...
$C$DW$756	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$756, DW_AT_name("TSS")
	.dwattr $C$DW$756, DW_AT_TI_symbol_name("_TSS")
...
$C$DW$757	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$757, DW_AT_name("TRB")
	.dwattr $C$DW$757, DW_AT_TI_symbol_name("_TRB")
...
$C$DW$759	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$759, DW_AT_name("SOFT")
	.dwattr $C$DW$759, DW_AT_TI_symbol_name("_SOFT")
...
$C$DW$760	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$760, DW_AT_TI_symbol_name("_FREE")
...
$C$DW$762	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$762, DW_AT_name("TIE")
	.dwattr $C$DW$762, DW_AT_TI_symbol_name("_TIE")
...
$C$DW$763	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$763, DW_AT_name("TIF")
	.dwattr $C$DW$763, DW_AT_TI_symbol_name("_TIF")
...
$C$DW$765	.dwtag  DW_TAG_member
	.dwattr $C$DW$765, DW_AT_type(*$C$DW$T$84)
...
$C$DW$766	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$766, DW_AT_name("LSW")
	.dwattr $C$DW$766, DW_AT_TI_symbol_name("_LSW")
	.dwattr $C$DW$766, DW_AT_bit_offset(0x00)
	.dwattr $C$DW$766, DW_AT_bit_size(0x10)
	.dwattr $C$DW$766, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$766, DW_AT_accessibility(DW_ACCESS_public)

$C$DW$767	.dwtag  DW_TAG_member
	.dwattr $C$DW$767, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$767, DW_AT_name("MSW")
	.dwattr $C$DW$767, DW_AT_TI_symbol_name("_MSW")
...
$C$DW$770	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$770, DW_AT_name("TDDRH")
	.dwattr $C$DW$770, DW_AT_TI_symbol_name("_TDDRH")
...
$C$DW$771	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$771, DW_AT_name("PSCH")
	.dwattr $C$DW$771, DW_AT_TI_symbol_name("_PSCH")
...
$C$DW$774	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$774, DW_AT_name("TDDR")
	.dwattr $C$DW$774, DW_AT_TI_symbol_name("_TDDR")
...
$C$DW$775	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$775, DW_AT_name("PSC")
	.dwattr $C$DW$775, DW_AT_TI_symbol_name("_PSC")
...
$C$DW$777	.dwtag  DW_TAG_member
	.dwattr $C$DW$777, DW_AT_type(*$C$DW$T$90)
...
$C$DW$T$107	.dwtag  DW_TAG_volatile_type
	.dwattr $C$DW$T$107, DW_AT_type(*$C$DW$778)
...
$C$DW$T$108	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$108, DW_AT_name("__uint32_t")
	.dwattr $C$DW$T$108, DW_AT_type(*$C$DW$T$13)
	.dwattr $C$DW$T$108, DW_AT_language(DW_LANG_C)

$C$DW$T$109	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$109, DW_AT_name("uint32_t")
...
$C$DW$831	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$831, DW_AT_name("STF_HWDIV")
	.dwattr $C$DW$831, DW_AT_location[DW_OP_regx 0x4f]
